...
//add_filter('mayosis_logo_image','dtbwp_mayosis_logo_image');
//function dtbwp_mayosis_logo_image($old_image_url){
				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'mayosis' ),
							'description' => __( 'Upgrade Content and Settings', 'mayosis' ),
							'pending' => __( 'Pending.', 'mayosis' ),
							'installing' => __( 'Installing Updates.', 'mayosis' ),
							'success' => __( 'Success.', 'mayosis' ),
