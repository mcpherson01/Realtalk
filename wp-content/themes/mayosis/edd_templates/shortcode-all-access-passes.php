		...
		<table id="edd_user_history">
			...
			<?php foreach( $customer_all_access_passes as $purchased_download_id_price_id => $purchased_aa_data ){
					...
					<tr>
						...
						<td>
							<span class="edd_all_access_pass_expiration_date"><?php echo $all_access_pass->expiration_time == 'never' ? __( 'Never Expires', 'mayosis' ) : date( 'M d, Y', $all_access_pass->expiration_time ); ?></span>
						</td>
						<td>
