<?php if( ! empty( $_GET['edd-verify-success'] ) ) : ?>
    <p class="edd-account-verified edd_success">
        <?php _e( 'Your account has been successfully verified!', 'mayosis' ); ?>
    </p>
<?php
endif;
/**
...
if ( $purchases ) :
    ...
    <table id="edd_user_history" class="edd-table">
        ...
        <tr class="edd_download_history_row">
            ...
            <th class="edd_download_download_name"><?php _e( 'Product Name', 'mayosis' ); ?></th>
            <?php if ( ! edd_no_redownload() ) : ?>
                <th class="edd_download_download_files"><?php _e( 'Files', 'mayosis' ); ?></th>
                            ...
                            <td class="edd_download_download_files">
                                ...
                                if ( 'publish' == $payment->post_status ) :
                                    ...
                                    if ( $download_files ) :
                                        ...
                                        foreach ( $download_files as $filekey => $file ) :
                                            ...
                                            <div class="edd_download_file">
                                                <a href="<?php echo esc_url( $download_url ); ?>" class="edd_download_file_link">
                                                   <?php esc_html_e('Download','mayosis');?>
                                                </a>
                                            </div>
                                        ...
                                        echo "<li class='no-files-available'> <a>No Files</a></li>";
                                    endif; // End if payment complete

                                else : ?>
                                    <span class="edd_download_payment_status">
										<?php printf( __( 'Payment status is %s', 'mayosis' ), edd_get_payment_status( $payment, true) ); ?>
									</span>
                                <?php
...
<?php else : ?>
    <p class="edd-no-downloads"><?php _e( 'You have not purchased any downloads', 'mayosis' ); ?></p>
<?php endif; ?>
