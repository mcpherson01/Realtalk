...
<table id="edd_subscription_receipt">
	...
	<?php foreach ( $subscriptions as $subscription ) :
		...
		<tr>
			...
			<td>
				<span class="edd_subscription_times_billed"><?php echo $subscription->get_times_billed() . ' / ' . ( ( $subscription->bill_times == 0 ) ? __( 'Until cancelled', 'mayosis' ) : $subscription->bill_times ); ?></span>
			</td>
			<td>
				<span class="edd_subscription_status <?php echo $subscription->get_status_label(); ?>"><?php echo $subscription->get_status_label(); ?></span>
			</td>
		</tr>
	<?php endforeach; ?>
	</tbody>
