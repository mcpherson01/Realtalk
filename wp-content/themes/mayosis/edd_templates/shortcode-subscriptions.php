		...
		<table id="edd_user_history">
			...
			<?php foreach ( $subscriptions as $subscription ) :
				...
				<tr>
					...
					<td>
						<span class="edd_subscriptiontimes_billed"><?php echo $subscription->get_times_billed() . ' / ' . ( ( $subscription->bill_times == 0 ) ? __( 'Until cancelled', 'mayosis' ) : $subscription->bill_times ); ?></span>
					</td>
					<td>
