...
if ( is_user_logged_in() ) {
	...
	if ( 'invalid' == $all_access_pass->status ) {
		...
		<p class="edd-sl-manage-license-details">
			<span class="edd-sl-manage-license-product"><?php _e( 'Product', 'mayosis' ); ?>: <span><?php echo $download->get_name(); ?></span></span>
		</p>
					...
					<tr class="edd_all_access_pass_details_row">
						...
						<td class="row-value">
							...
							if ( 'upgraded' == $all_access_pass->status ){
								...
								echo $all_access_pass->expiration_time == 'never' ? __( 'Never Expires', 'mayosis' ) : date( 'M d, Y, g:i a', $all_access_pass->expiration_time );
							}
							?></span>
						</td>
						<?php do_action( 'edd_all_access_pass_details_row_end', $all_access_pass ); ?>
