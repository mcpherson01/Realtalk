        ...
        <form name="vendor_list_sort" method="post">
            ...
            <div class="wcmp-store-map-filter">
                <div class="wcmp-inp-wrap wcmp-email">
                    <input type="text" name="locationText" id="locationText" placeholder="<?php esc_html_e('Enter Address', 'urna'); ?>" value="<?php echo isset($request['locationText']) ? $request['locationText'] : ''; ?>">
                </div>
                ...
                <input type="submit" name="vendorListFilter" value="<?php esc_html_e('Submit', 'urna'); ?>">
            </div>
        </form>
        <?php endif; ?>
        <div class="wcmp-store-map-pagination">
            ...
            <form name="vendor_sort" method="post" >
                <div class="vendor_sort">
                    ...
                    <input value="<?php echo esc_html__('Sort', 'urna'); ?>" type="submit">
                </div>
            </form>
