    ...
    <?php while ( $loop->have_posts() ): $loop->the_post(); global $product; ?>
		...
		<div class="item">
	        <div class="products-grid product">
	            <?php wc_get_template( 'item-product/vertical.php', array('show_des' => $show_des, 'countdown' => $countdown, 'countdown_title' => $countdown_title, 'flash_sales' => $flash_sales, 'end_date' => $end_date ) ); ?>
	        </div>
