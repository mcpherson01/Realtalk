            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'class' => 'big-divide',
                        'type' => 'divide',
                        'required' => array('active_theme','=','furniture')
                    ),
                    array(
                    ...
                    array(
                        ...
                        'required' => array('enable_flash_sale','equals',true),
                        'subtitle' => esc_html__('Image File (.png or .gif)', 'urna'),
                    ),
                    array(
                ...
                'fields' => array(       
                    array(
                        ...
                        'options'  => array(
                            ...
                            'Save ${price-diff}' => esc_html__('Save ${price-diff} (e.g "Save $50")' ,'urna'),
                    ...
                    array(
                        ...
                        'desc'      => esc_html__('{price-diff} inserts the dollar amount off.', 'urna'). '</br>'.
                                       esc_html__('{percent-diff} inserts the percent reduction (rounded).', 'urna'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'required' => array('recentview_viewall_text','equals', true),
                    ),
