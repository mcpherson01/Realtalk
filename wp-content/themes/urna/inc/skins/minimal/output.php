...
$output['header_link_color'] 			= array(
	'color' => urna_texttrim('.navbar-nav.megamenu > li > a, #tbay-search-form-canvas button, .tbay-login >a, .top-wishlist a, .cart-dropdown .cart-icon, .canvas-menu-sidebar >a'),
...
$output['footer_text_color'] 			= array('.tbay-footer .wpb_text_column, .copyright');
$output['footer_link_color'] 			= array('.contact-info a, .tbay-footer .menu.treeview li > a, .tbay-addon-social .social.style3 > li a, .tbay-copyright a, .tbay-copyright .tbay-addon-newletter .input-group-btn:before');
$output['footer_link_color_hover'] 		= array('.contact-info a:hover, .tbay-footer .menu.treeview li > a:hover, .tbay-addon-social .social.style3 > li a:hover, .tbay-copyright a:hover, .tbay-copyright .tbay-addon-newletter .input-group-btn:hover:before, .tbay-footer ul.menu li.active a');
