...
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.tbay-addon-features .inner .ourservice-heading:hover,#tbay-search-form-canvas.v4 button:hover,#tbay-search-form-canvas.v4 button:hover i,#tbay-search-form-canvas.v4 .sidebar-canvas-search .sidebar-content .select-category .optWrapper .options li:hover label , #tbay-search-form-canvas.v4 .autocomplete-suggestions > div .suggestion-group:hover .suggestion-title';  
...
$output['header_link_color'] 			= array(
	'color' => urna_texttrim('.navbar-nav.megamenu > li > a, .top-wishlist a, .cart-dropdown .cart-icon, .tbay-login > a,.canvas-menu-sidebar .btn-canvas-menu, #tbay-search-form-canvas button'),
	'background-color' => urna_texttrim(''),
);

$output['header_link_color_active'] = array( 
	'color' => urna_texttrim('.navbar-nav.megamenu > li.active > a,.recent-view h3:hover,.navbar-nav.megamenu > li:hover > a,.navbar-nav.megamenu > li > a:hover, .tbay-login >a:hover, .top-wishlist a:hover, .cart-dropdown:hover .cart-icon, .canvas-menu-sidebar .btn-canvas-menu:hover, #tbay-search-form-canvas button:hover'),
	'background-color' => urna_texttrim(''),
);
...
$output['footer_heading_color'] 		= array('.tbay-footer .tbay-addon .tbay-addon-title,.footer .tbay-addon.tbay-addon-newletter > h3');
