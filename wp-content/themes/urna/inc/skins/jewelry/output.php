...
$main_color_skin 	= '.has-after:hover,button.btn-close:hover,.new-input + span:before,.new-input + label:before,.tbay-footer .tbay-addon-newletter .input-group-btn:hover:before,.tbay-addon-social .social.style3 li a:hover,.woocommerce .products .star-rating span:before,.woocommerce .product .star-rating span:before,.woocommerce .star-rating span:before';  
...
$main_border_skin 	= '.btn-theme-2 , .product-block.v14 .group-buttons > div a.added,.product-block.v14 .button-wishlist a:hover,.product-block.v14 .yith-wcwl-wishlistexistsbrowse.show a,.product-block.v14 .yith-wcwl-wishlistaddedbrowse.show a';
...
$output['header_link_color'] 			= array('#tbay-header .canvas-menu-sidebar .btn-canvas-menu, .tbay-login >a, .top-wishlist a, .cart-dropdown .cart-icon, .navbar-nav.megamenu > li > a');

$output['header_link_color_active'] = array( 
	'color' => urna_texttrim('#tbay-header .canvas-menu-sidebar .btn-canvas-menu:hover, .tbay-login >a:hover, .top-wishlist a:hover, .cart-dropdown .cart-icon:hover, .navbar-nav.megamenu > li > a:hover, .navbar-nav.megamenu > li > a:focus, .navbar-nav.megamenu > li:hover > a, .navbar-nav.megamenu > li:focus > a, .navbar-nav.megamenu > li.active > a'),
...
$output['main_menu_link_color_active'] 	= array('.navbar-nav.megamenu > li > a:hover, .navbar-nav.megamenu > li > a:focus, .navbar-nav.megamenu > li.active > a, .navbar-nav.megamenu > li:hover > a, .navbar-nav.megamenu > li:focus > a');
...
$output['footer_text_color'] 			= array('.tbay-footer .vc_row:not(.tbay-copyright) .wpb_text_column p, .tbay-footer .tbay-copyright .wpb_text_column');
$output['footer_link_color'] 			= array('.contact-info a, .tbay-footer .menu.treeview li > a, .tbay-addon-social .social.style3 > li a, .tbay-footer .tbay-copyright .tbay-addon-newletter .input-group-btn:before');
$output['footer_link_color_hover'] 		= array('.contact-info a:hover, .tbay-footer .menu.treeview li > a:hover, .tbay-addon-social .social.style3 > li a:hover, .tbay-footer .tbay-copyright .tbay-addon-newletter .input-group-btn:hover:before, .tbay-footer ul.menu li.active a');
