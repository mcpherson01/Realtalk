...
class MiniCart {
  ...
  remove_click_Outside() {
    ...
    win.on("click.Bst,click touchstart tap", function (event) {
      let box_popup = $('#tbay-header .top-cart .dropdown-content .widget_shopping_cart_content, .top-cart .widget-header-cart > span, .top-cart .heading-title, .topbar-device-mobile .top-cart .dropdown-content .widget_shopping_cart_content, a.ajax_add_to_cart, .top-cart .cart_list a.remove');
  ...
  minicartTopContent() {
    let cart_content = $('#tbay-header .top-cart .dropdown-content .widget_shopping_cart_content'),
        cart_top = cart_content.parent().find('.widget-header-cart').outerHeight(),
        list_cart = $('#tbay-header .top-cart .dropdown-content .widget_shopping_cart_content .mcart-border ul.product_list_widget'),
  ...
  minicartTopContentmobile() {
    let cart_content = $('.topbar-device-mobile .top-cart .dropdown-content .widget_shopping_cart_content'),
        cart_top = cart_content.parent().find('.widget-header-cart').outerHeight(),
        list_cart = $('.topbar-device-mobile .top-cart .dropdown-content .widget_shopping_cart_content .mcart-border ul.product_list_widget'),
        group_button = list_cart.next().outerHeight();
    cart_content.css("top", cart_top);
    list_cart.css("bottom", group_button + 10);
  }
...
class SingleProduct {
  ...
  _initBuyNow() {
    ...
    $('form.cart').change(function () {
      let is_submit_disabled = $(this).find('[type="submit"]').is('.disabled');
