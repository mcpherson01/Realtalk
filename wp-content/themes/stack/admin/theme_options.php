...
<a class="btn btn--primary type--uppercase" href="#purchase-template">Drop your resumé here</a>';
	...
	$ebor_options->add_setting('select', 'stack_use_vertical_responsive', 'Use Vertical Slide In Menu Style on mobile? Note, this will not affect the full screen navigation style', 'header_layout_section', 'no', 45, $yesNo);
	...
	$ebor_options->add_setting('input', 'stack_menu_font_size', 'Menu Item Size (1em Default)', 'advanced_type_section', '1em', 70);
