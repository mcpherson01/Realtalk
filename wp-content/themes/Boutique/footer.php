	...
	<div id="footer-bottom">
		<div class="container clearfix">
			...
			?>
			<p id="copyright"><?php esc_html_e('Designed by ','Boutique'); ?> <a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant Themes</a> | <?php esc_html_e('Powered by ','Boutique'); ?> <a href="http://www.wordpress.org">WordPress</a></p>
		</div> <!-- end .container -->
