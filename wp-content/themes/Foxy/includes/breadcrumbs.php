...
<div id="breadcrumbs">
	<?php if(function_exists('bcn_display')) { bcn_display(); }
				...
				<a href="<?php echo esc_url( home_url() ); ?>" class="breadcrumbs_home"><?php esc_html_e('Home','Foxy') ?></a> <span class="raquo">&raquo;</span>

				<?php if( is_tag() ) { ?>
					<?php esc_html_e('Posts Tagged ','Foxy') ?><span class="raquo">&quot;</span><?php single_tag_title(); echo('&quot;'); ?>
				<?php } elseif (is_day()) { ?>
					<?php esc_html_e('Posts made in','Foxy') ?> <?php the_time('F jS, Y'); ?>
				<?php } elseif (is_month()) { ?>
					<?php esc_html_e('Posts made in','Foxy') ?> <?php the_time('F, Y'); ?>
				<?php } elseif (is_year()) { ?>
					<?php esc_html_e('Posts made in','Foxy') ?> <?php the_time('Y'); ?>
				<?php } elseif (is_search()) { ?>
					<?php esc_html_e('Search results for','Foxy') ?> <?php the_search_query() ?>
				...
				<?php } elseif (is_author()) { ?>
					...
					?>
					<?php esc_html_e('Posts by ','Foxy'); echo ' ',$curauth->nickname; ?>
				<?php } elseif (is_page()) { ?>
