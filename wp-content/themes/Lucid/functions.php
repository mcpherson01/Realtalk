...
if ( ! function_exists( 'et_setup_theme' ) ){
	function et_setup_theme(){
		...
		require_once( $template_directory . '/includes/post_thumbnails_lucid.php' );
...
function et_add_google_fonts(){
	wp_enqueue_style( 'google_font_open_sans', '//fonts.googleapis.com/css?family=Open+Sans:400,700,300' );
	wp_enqueue_style( 'google_font_open_sans_condensed', '//fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700' );
}
