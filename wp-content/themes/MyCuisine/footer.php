	...
	<div id="footer">
		<div class="container">
			...
			<div id="footer-bottom" class="clearfix<?php if ( !is_home() ) echo ' nobg'; ?>">
				...
				?>
				<p id="copyright"><?php esc_html_e('Designed by ','MyCuisine'); ?> <a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant Themes</a> | <?php esc_html_e('Powered by ','MyCuisine'); ?> <a href="http://www.wordpress.org">WordPress</a></p>
