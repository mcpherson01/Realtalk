<?php if (get_option('artsee_delete_button') == 'on' && !is_singular()) { ?>
	<!--Begin Delete Button-->
	<img src="<?php echo get_template_directory_uri(); ?>/images/delete.gif" alt="delete" class="delete" style="float: right; margin-bottom: 5px; cursor: pointer;" />
	<!--End Delete Button-->
<?php }; ?>

<?php if (get_option('artsee_share_button') == 'on') { ?>
	<!--Begin Share Button-->
