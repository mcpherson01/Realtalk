...
if ( ! function_exists( 'et_setup_theme' ) ){
	function et_setup_theme(){
		...
		require_once($template_dir . '/includes/post_thumbnails_sky.php');
...
function et_add_google_fonts(){
	echo '<link href="https://fonts.googleapis.com/css?family=Goudy+Bookletter+1911" rel="stylesheet" type="text/css" />';
}
