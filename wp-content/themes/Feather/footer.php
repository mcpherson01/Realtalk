	...
	<div id="footer">
		<div class="container">
			...
			<div id="footer-bottom" class="clearfix">
				...
				?>
				<p id="copyright"><?php printf( __('Designed by %s | Powered by %s', 'Feather'), '<a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant Themes</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
