...
class seopress_pro_options
{
    ...
    public function print_pro_section($key) {
        ...
        $sections = array(
            ...
            'robots'=> array(
                'toggle' => 1,
                'icon' => 'media-text',
                'title' => __('Robots','wp-seopress-pro'),
            ...
            '404'=> array(
                'toggle' => 1,
                'icon' => 'admin-links',
                'title' => __('404 monitoring','wp-seopress-pro'),
            ...
            'backlinks'=> array(
                'icon' => 'admin-links',
                'title' => __('Backlinks','wp-seopress-pro'),
                'desc' => __('Check your backlinks with Majestic. You need to enter your own Majestic API key to use this feature.', 'wp-seopress-pro')
            ),
            'rewrite'=> array(
                'toggle' => 1,
                'icon' => 'admin-links',
    ...
    public function print_section_info_backlinks() {
        $this->print_pro_section('backlinks');
    ...
    public function seopress_rich_snippets_publisher_logo_callback()
    {
        ...
        echo '<ul class="seopress-list notice notice-error">';
        echo '<li>';
...
User-agent: SemrushBot-SA
    ...
    public function seopress_white_label_admin_menu_callback()
    {
        ...
        echo '<p class="description"><span class="dashicons dashicons-info"></span><a href="https://developer.wordpress.org/resource/dashicons/" target="_blank" rel="nofollow noopener noreferrer">'.__('Find your Dashicons CSS class name on the official website','wp-seopress-pro').'</a><span class="dashicons dashicons-external"></span></p>';
    }
