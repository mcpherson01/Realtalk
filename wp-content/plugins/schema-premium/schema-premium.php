...
final class Schema_Premium {
	...
	public static function instance() {
		...
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Schema_Premium ) ) {
			...
			if ( class_exists( 'ACF' ) ) {
				add_action( 'admin_notices', array( self::$instance, 'acf_plugin_installed_notice' ) );
			}
	 ...
	 * @return void
	 */
	public function acf_plugin_installed_notice() {
		echo '<div class="error"><p>' . __( 'Please, deactivate Advanced Custom Fields (ACF) plugin for Schema Premium to work properly! <br><br>The Schema Premium plugin includes Advanced Custom Fields PRO (ACF PRO) plugin in its core, this means when you install Schema Premium you will have the latest ACF PRO version loaded to your site.', 'schema-premium' ) . ' <a target="_blank" href="https://schema.press/docs-premium/advanced-custom-fields-pro/">'.__('Learn more', 'schema-premium').'</a></p></div>';
	}
