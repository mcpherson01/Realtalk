...
add_action( 'acf/init', 'schema_premium_acf_meta_video_object_details' );
/**
...
function schema_premium_acf_meta_video_object_details() {
	...
	if( function_exists('acf_add_local_field_group') ):
		...
		acf_add_local_field_group(array (
			'key' => 'group_schema_VideoObject_details',
			'title' => __('Video Details', 'schema-premium'),
			'location' => array (
				array (
		...
		acf_add_local_field( array(
			...
			'type'         => 'repeater',
			'parent'       => 'group_schema_VideoObject_details',
			'instructions' => $properties_instructions_enable == 'yes' ? __('Mark up your video content manually with structured data to make Google Search an entry point for discovering and watching videos. Use this feature if your videos are not supported by Schema Premium plugin.', 'schema-wp-types') : '',
			'layout' 	   => 'block',
			'button_label' => __('Add Video Details', 'schema-wp-types')
		) );
