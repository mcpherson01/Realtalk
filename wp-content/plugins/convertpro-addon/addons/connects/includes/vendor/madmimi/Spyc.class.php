<?php
/**
   * CPRO_Spyc -- A Simple PHP YAML Class
   * @version 0.4.5
...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return CPRO_Spyc::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_load_file')) {
  ...
  function spyc_load_file ($file) {
    return CPRO_Spyc::YAMLLoad($file);
  }
}
...
/**
   ...
   * Usage:
   * <code>
   *   $CPRO_Spyc  = new CPRO_Spyc;
   *   $array = $CPRO_Spyc->load($file);
   * </code>
   * or:
   * <code>
   *   $array = CPRO_Spyc::YAMLLoad($file);
   * </code>
   * or:
   * <code>
...
/**
 * Load a valid YAML string to CPRO_Spyc.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to CPRO_Spyc.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = CPRO_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = CPRO_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  public static function YAMLLoadString($input) {
    $CPRO_Spyc = new CPRO_Spyc;
    return $CPRO_Spyc->_loadString($input);
  }
...
// Enable use of CPRO_Spyc from command line
...
do {
  ...
  $file = $argv[1];
  printf ("CPRO_Spyc loading file: %s\n", $file);
