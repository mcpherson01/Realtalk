...
class CPRO_iContactApi {
	 ...
	 * @static
	 * @access public
	 * @param CPRO_iContactApi $oInstance Instance to set to
	 * @return CPRO_iContactApi $this
	**/
	...
	**/
	 ...
	 * @return object
	**/
		public function addContact( $contactDetails = array(), $sStatus = 'normal' ) {
		// Valid statuses
	...
	**/
	...
	/**
	 * This method subscribes a contact to a segment
	 * @access public
	 * @param integer $iListId
	 * @return object
	 **/

	public function subscribeContactToSegment( $iListId, $segment_id ) {
		// Setup the subscription and make the call
		$aSubscriptions = $this->makeCall("/a/{$this->setAccountId()}/c/{$this->setClientFolderId()}/segments/{$segment_id}", 'POST', array(
			array(
				'listid'    	 => $iListId
			)
		), 'segments');
	...
	**/
	public function getSegments() {
		// Make the call and return the segments
		return $this->makeCall("/a/{$this->setAccountId()}/c/{$this->setClientFolderId()}/segments", 'GET', null, 'segments');
	}
