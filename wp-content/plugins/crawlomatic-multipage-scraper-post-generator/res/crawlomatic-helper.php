       ...
       if(isset($_POST['crawlomatic_crawl']) && isset($_POST['crawlomatic_crawl_url']))
       {
           if (filter_var($_POST['crawlomatic_crawl_url'], FILTER_VALIDATE_URL)) {
               if(isset($_POST['crawlomatic_use_phantomjs_help']) && $_POST['crawlomatic_use_phantomjs_help'] == 'on')
               {
                   ...
                   {
                       $crawled_content = 'Error in page crawling. Please try crawling the page without PhantomJS. Also, please check if PhantomJS is properly configured on your server.';
                   }
               }
               else
               {
           ...
           {
               $crawled_content = 'Invalid URL provided: ' . esc_url($_POST['crawlomatic_crawl_url']);
           }
       }
   ?>
