                     ...
                     <tr>
                        ...
                        <th>
                           ...
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Input the URL which you want to use as a crawling starting point. This URL will also be scraped.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                        </th>
                                    ...
                                    <div class="table-responsive">
                                       <table class="responsive cr_main_table_nowr">
                                          ...
                                          <tr>
                                             <td class="cr_min_240">
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Generated Post Title:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                             </td>
                                             <td>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Generated Post Content:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                             </td>
                                             <td>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Run regex on post content. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Replace the above regex matches with this regex expression. If you want to strip matched content, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Run regex on post title. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                          ...
                                          <tr>
                                             <td class="cr_min_width_200">
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Post Custom Fields:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                             </td>
                                             <td>
                                          ...
                                          <tr>
                                             <td class="cr_min_width_200">
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Post Custom Taxonomies:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                             </td>
                                             <td>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                             <textarea rows="1" cols="70" name="crawlomatic_rules_list[user_pass][]" placeholder="http_user:http_pass" class="cr_width_full"></textarea>
                                             </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td class="cr_min_width_200">
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text cr_min_260px">
                                                         <?php
                                                            echo esc_html__("Select the user agent value you want to send with each request. If crawling fails for a webpage, you can try to set here a custom value. Example of Google Chrome user agent: Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36", 'crawlomatic-multipage-scraper-post-generator');
                                                            ?>
                                                      </div>
                                                   </div>
                                             ...
                                             <td>
                                             <textarea rows="1" cols="70" name="crawlomatic_rules_list[custom_user_agent][]" placeholder="Please insert your desired user agent" class="cr_width_full"></textarea>
                                             </div>
                                             </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   ...
                                                   <b><?php echo esc_html__("Use PhantomJs To Parse JavaScript On Pages:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                                                </div>
                                             </td>
                                             <td>
                                                <div>
                                                   <input type="checkbox" id="use_phantom" name="crawlomatic_rules_list[use_phantom][]">               
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td>
                                                <div>
                                                   <select id="seed_type" name="crawlomatic_rules_list[seed_type][]" class="crawlomatic_selector cr_width_full" data-source-field-id="crawlomatic_crawl_start" data-target-field-id="seed_expre" data-target-field-cont="">
                                                      ...
                                                      <option value="regex"><?php echo esc_html__("Regex", 'crawlomatic-multipage-scraper-post-generator');?></option>
                                                   </select>
                                                </div>
                                             </td>
                                          </tr>
     ...
     <div class="codemodalfzr-content">
       ...
       <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Generated Post Title", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       
                       </td><td>
                       <input type="text" name="crawlomatic_rules_list[post_title][]" value="' . htmlspecialchars($post_title) . '" placeholder="Please insert your desired post title. Example: %%item_title%%" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Generated Post Content", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Run regex on post content. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Replace the above regex matches with this regex expression. If you want to strip matched content, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Run regex on post title. To disable this feature, leave this field blank.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
   	...
   	foreach($GLOBALS['language_names'] as $lang){
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Post Custom Fields", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Post Custom Taxonomies", 'crawlomatic-multipage-scraper-post-generator') . ':</b>
                       </td><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" cols="70" name="crawlomatic_rules_list[custom_cookies][]" placeholder="Please insert your desired cookies. Example: cookie_key1=cookie_value1; cookie_key2=cookie_value2" class="cr_width_full">' . esc_textarea($custom_cookies) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" cols="70" name="crawlomatic_rules_list[user_pass][]" placeholder="http_user:http_pass" class="cr_width_full">' . esc_textarea($user_pass) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" cols="70" name="crawlomatic_rules_list[custom_user_agent][]" placeholder="Please insert your desired user agent" class="cr_width_full">' . esc_textarea($custom_user_agent) . '</textarea>
   	...
   	foreach($GLOBALS['encodings'] as $enc){
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Use PhantomJs To Parse JavaScript On Pages", 'crawlomatic-multipage-scraper-post-generator') . ':</b>';
                       if($use_phantom == '1')
                       {
                           if($phantom === false)
                           {
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       $output .= '>' . esc_html__("Regex", 'crawlomatic-multipage-scraper-post-generator') . '</option>
                   </select>              
           </div>
           </td></tr><tr><td>
           <div>
