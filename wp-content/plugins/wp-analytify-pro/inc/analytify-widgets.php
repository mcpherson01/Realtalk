...
class ANALYTIFY_WIDGET_REALTIME extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html_e( 'Analytify Live Stats', 'wp-analytify-pro' ), // Name
            array( 'description' => esc_html_e( 'It shows Live Stats of your site.', 'wp-analytify-pro' ), ) // Args
        );
    }
    ...
    function form($instance) {
        ...
        <p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e( 'Title', 'wp-analytify-pro' ); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
        </p>

        <p>
        <label for="<?php echo $this->get_field_id('description'); ?>"><?php esc_html_e( 'Description:', 'wp-analytify-pro' ); ?></label>
