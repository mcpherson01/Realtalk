        ...
        if ((isset($wp_query->query_vars[$this->getRouteVar('webhook-callback')])) && !is_null($wp_query->query_vars[$this->getRouteVar('webhook-callback')])) {
            ...
            if (!empty($data['entry'][0]['messaging'])) {
                foreach ($data['entry'][0]['messaging'] as $message) {
                    ...
                    $check = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."njt_fb_mess_senders WHERE `sender_id` = '".$sender."'");
        ...
        if (!empty($code)) {
            ...
            if ($json) {
                ...
                */
                ...
                if (isset($rows_item[0]) && !empty($rows_item)) { //$json->status !== false
                    if ($rows_item[0] == '19344381') { //$json->data == '19344381'
                        ////get current site
                        ...
                        if($check_active > 0){
                            ...
                            wp_send_json_error(array('html' => __('Your Purchase Code is expired.', NJT_FB_MESS_I18N)));
                        }
