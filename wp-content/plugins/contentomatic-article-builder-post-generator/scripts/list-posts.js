...
registerBlockType( 'contentomatic-article-builder-post-generator/contentomatic-list', {
    title: 'Contentomatic List Posts',
    icon: 'testimonial',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['list', 'posts', 'contentomatic'],
    edit: (function( props ) {
