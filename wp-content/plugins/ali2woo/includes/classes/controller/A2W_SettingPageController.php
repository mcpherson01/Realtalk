    ...
    class A2W_SettingPageController extends A2W_AbstractAdminPage {
        ...
        public function ajax_update_price_rules() {
            ...
            try {
                ...
                $use_regular_price_as_base = isset($_POST['use_regular_price_as_base']) ? filter_var($_POST['use_regular_price_as_base'], FILTER_VALIDATE_BOOLEAN) : false;
                ...
                a2w_set_setting('use_regular_price_as_base', $use_regular_price_as_base);
