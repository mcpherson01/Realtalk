		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'.tooltipster-sidetip.uael-tooltip-wrap-{{ID}} .tooltipster-content, .tooltipster-sidetip.uael-tooltip-wrap-{{ID}} .uael-tour li a, .tooltipster-sidetip.uael-tooltip-wrap-{{ID}} .uael-tour-active .uael-hotspot-end a' => 'color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default'   => '',
					'selectors' => [
						'.tooltipster-sidetip.uael-tooltip-wrap-{{ID}} .tooltipster-box' => 'background-color: {{VALUE}};',
