...
class PLL_Settings extends PLL_Admin_Base {
	...
	public function __construct( &$links_model ) {
		...
		add_action('admin_init', function(){
			...
			add_action( 'load-' . AitLanguages::$pageSlug,  array( $this, 'load_page' ) );
		});
	...
	public function add_menus() {
		add_submenu_page( 'admin.php', $title = __( 'Languages', 'polylang' ), $title, 'manage_options', 'mlang', array( $this, 'languages_page' ) );
	}
