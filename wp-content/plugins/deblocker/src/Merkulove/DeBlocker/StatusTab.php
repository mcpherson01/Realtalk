...
final class StatusTab {
	...
	public function add_settings() {
		...
		/** Uninstall Tab. */
		register_setting( 'DeBlockerStatusOptionsGroup', 'mdp_deblocker_status_settings' );
		add_settings_section( 'mdp_deblocker_settings_page_status_section', '', null, 'DeBlockerStatusOptionsGroup' );
	...
	public function render_form() {
		...
		settings_fields( 'DeBlockerStatusOptionsGroup' );
		do_settings_sections( 'DeBlockerStatusOptionsGroup' );
	...
	public function render_system_requirements() {
		...
		<div class="mdc-system-requirements">
			...
			<?php foreach ( $reports as $key => $report ) : ?>
                <div class="mdp-deblocker-<?php echo esc_attr( $key ); ?>">
	...
	public function render_changelog() {
		...
		$slug = strstr( DeBlocker::$basename, "/", true );
	...
	public function render_privacy_notice() {
        ...
        <div class="mdc-text-field-helper-line">
            <div class="mdc-text-field-helper-text mdc-text-field-helper-text--persistent"><?php esc_html_e( 'Some data will be sent to our server to verify purchase and to ensure that a plugin is compatible with your install. We will never collect any confidential data. All data is stored anonymously.', 'deblocker' );?></div>
        </div>
        <?php
    }
