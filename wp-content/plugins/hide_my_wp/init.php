...
if (version_compare( $wp_version, '4.7', '>=') && $this->opt('full_hide')){
    ...
    */
    ...
    if ($this->opt('rename_plugins')){
        ...
        $path = trim($this->opt('new_plugin_path'), ' /') .'/'. 'el/assets';
        $rs_path = trim($this->opt('new_plugin_path'), ' /') .'/'. 'rs';
    }
    
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/eicons/css/elementor-icons.min.css=='. $path .'/lib/eicons/css/elementor-icons.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/css/common.min.css=='. $path .'/css/common.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/font-awesome/css/font-awesome.min.css=='. $path .'/lib/font-awesome/css/font-awesome.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/backbone/backbone.marionette.min.js=='. $path .'/lib/backbone/backbone.marionette.min.js';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/backbone/backbone.radio.min.js=='. $path .'/lib/backbone/backbone.radio.min.js';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/js/common-modules.min.js=='. $path .'/js/common-modules.min.js';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/dialog/dialog.min.js=='. $path .'/lib/dialog/dialog.min.js';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/js/common.min.js=='. $path .'/js/common.min.js';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/animations/animations.min.css=='. $path .'/lib/animations/animations.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/css/frontend.min.css=='. $path .'/css/frontend.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/font-awesome/css/fontawesome.min.css=='. $path .'/lib/font-awesome/css/fontawesome.min.css';
    $this->auto_replace_urls[]= $prefix .'wp-content/plugins/elementor/assets/lib/font-awesome/css/solid.min.css=='. $path .'/lib/font-awesome/css/solid.min.css';
