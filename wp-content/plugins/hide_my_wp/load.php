...
if ($this->opt('blocked_ips') || ($this->opt('trust_network'))) {
    ...
    $banned_ips = array_merge($malware_ips,$banned_ips);    
    ...
    $banned_params = isset($rules['param']) && empty($rules['param']) ? explode(',', $rules['param']) : array();
