...
class PP_Settings_API {
    ...
    public function register_menu() {
        ...
        if ($this->settings_menu['multisite_only']) {
            ...
            add_submenu_page('hide_my_wp_dashboard', __( 'Trust Nwtwork', 'mute-screamer' ), __('Trust Network', 'hmwp'), 'activate_plugins', 'hmwp_trust_network', array($this,'hmwp_render_trust_network_page'));
     ...
     */
    public function hmwp_render_trust_network_page(){
        global $wpdb;
        ...
        // Get results
        $search = isset( $_GET['ip_search'] ) ? stripslashes( $_GET['ip_search'] ) : '';
        $search_title = '';
        if ( $search ) {
                $search_title = sprintf( '<span class="subtitle">' . __( 'Search results for &#8220;%s&#8221;', 'mute-screamer' ) . '</span>', esc_html( $search ) );
                $token = '%'.$search.'%';
                $sql = $wpdb->prepare( 'SELECT SQL_CALC_FOUND_ROWS * FROM ' . $wpdb->prefix . 'hmwp_blocked_ips WHERE (ip LIKE %s ) ORDER BY created DESC LIMIT %d, %d', $token, $offset, $limit );
        } else {
                $sql = $wpdb->prepare( 'SELECT SQL_CALC_FOUND_ROWS * FROM ' . $wpdb->prefix . 'hmwp_blocked_ips ORDER BY created DESC LIMIT %d, %d', $offset, $limit );
        }
        $blocked_ips = $wpdb->get_results( $sql );
        $total_ips = $wpdb->get_var( 'SELECT FOUND_ROWS();' );

        // Construct pagination links
        $num_pages  = ceil( $total_ips / $per_page );
        $pagination = HMWP_MS_Utils::pagination( $pagenum, $num_pages, $per_page, $total_ips );
        // Columns
        $columns = array(
                'ip' => __( 'IP Address', 'mute-screamer' ),
                'date' => __( 'Date', 'mute-screamer' )
        );
        ?>
        <div class="wrap">
            <h2>HMWP Blocked IP Addresses <?php echo $search_title; ?></h2>
            <form method="get" action="admin.php" class="search-form">
                    <input type="hidden" value="<?php echo 'hmwp_trust_network';?>" name="page"/>
                    <p class="search-box">
                            <label for="s" class="screen-reader-text"><?php _e( 'Search IP', 'mute-screamer' ); ?></label>
                            <input type="text" value="<?php echo esc_attr( $search ); ?>" name="ip_search" id="hmwp_ms-intrusions-search-input"/>
                            <input type="submit" class="button" value="<?php _e( 'Search IP Address', 'mute-screamer' ); ?>"/>
                    </p>
            </form>
            <div class="tablenav">
                <?php echo $pagination; ?>
            ...
            <table cellspacing="0" class="widefat fixed">
                <thead>
                    <tr class="thead">
                        <th style="" class="manage-column" id="cb" scope="col">Sr. No</th>
                    ...
                    <tbody id="hmwp_ip_list">
                        ...
                        foreach($blocked_ips as $blocked_ip) : ?>
                            <tr>
                                ...
                                <td><?php echo date( "M d Y h:i:s", strtotime( $blocked_ip->created )); ?></td>
                            </tr>
                        <?php
                        $i++;
                        endforeach; ?>
            ...
            <form method="POST">
                <div class="setup-main-wrapper">
                    <div class="setup-element-wrap">
                        ...
                        <input style="display: none;" type="radio" name="setup-eb-setting" value='{"replace_javascript_path":"0","disable_directory_listing":"on","exclude_plugins_access":"","exclude_theme_access":"","replace_wpnonce":"","replace_mode":"safe","custom_404":"0","custom_404_page":"","login_query":"hide_my_wp","admin_key":"1234","remove_feed_meta":"on","hide_admin_bar":"","remove_other_meta":"on","clean_post_class":"","remove_menu_class":"","remove_default_description":"on","remove_ver_scripts":"","direct_access_except":"index.php, wp-content/repair.php, wp-comments-post.php, wp-includes/js/tinymce/wp-tinymce.php, xmlrpc.php, wp-cron.php","disable_canonical_redirect":"","email_from_name":"<?php echo get_bloginfo('blogname'); ?>","email_from_address":"<?php echo $admin_email; ?>","replace_in_html":"","new_theme_path":"/static","new_style_name":"","style_expiry_days":"","new_include_path":"/static/lib","new_plugin_path":"/static/ext","new_upload_path":"/file","replace_comments_post":"","replace_admin_ajax":"ajax","new_content_path":"","author_enable":"1","author_base":"","author_query":"","feed_enable":"1","feed_base":"","feed_query":"","post_enable":"1","post_base":"/blog/%year%/%monthnum%/%day%/%postname%/","post_query":"p","page_enable":"1","page_base":"","page_query":"page_id","paginate_enable":"1","paginate_base":"","paginate_query":"","category_enable":"1","category_base":"","category_query":"","tag_enable":"1","tag_base":"","tag_query":"","search_enable":"1","search_base":"","search_query":"","nice_search_redirect":"","import_options":"","export_options":"","debug_report":"","minify_new_style":"","clean_new_style":"","rename_plugins":"","separator2":"","author_without_base":"","disable_archive":"","disable_other_wp":"","trusted_user_roles":"","hide_wp_login":"on","hide_wp_admin":"on","spy_notifier":"","separator":"","remove_body_class":"","remove_html_comments":"","antispam":"on","avoid_direct_access":"","hide_other_wp_files":"on","enable_ids":"","ids_level":"0","ids_admin_include":"","ids_cookie":"","log_ids_min":"10","block_ids_min":"30","full_hide":"","cdn_path":"","li":"","customized_htaccess":"","email_ids_min":"30","ids_html_fields":"","replace_in_ajax":"","blocked_ip_message":"You are blocked. Please contact site administrator if you think there is a problem.","blocked_countries":"","blocked_ips":"","new_login_path":"","help_trust_network":"","trust_network":"on","exception_fields":"REQUEST.comment[new_line]POST.comment[new_line]REQUEST.permalink_structure[new_line]POST.permalink_structure[new_line]REQUEST.selection[new_line]POST.selection[new_line]REQUEST.content[new_line]POST.content[new_line]REQUEST.__utmz[new_line]COOKIE.__utmz[new_line]REQUEST.s_pers[new_line]COOKIE.s_pers[new_line]REQUEST.user_pass[new_line]POST.user_pass[new_line]REQUEST.pass1[new_line]POST.pass1[new_line]REQUEST.pass2[new_line]POST.pass2[new_line]REQUEST.password[new_line]POST.password[new_line]POST.hide_my_wp.%[new_line]REQUEST.hide_my_wp.%[new_line]POST.%import%[new_line]REQUEST.%import%[new_line]REQUEST.newcontent[new_line]POST.newcontent[new_line]REQUEST.remember_%"}' />
                    ...
                    <div class="setup-element-wrap">
                        ...
                        <input style="display: none;" type="radio" name="setup-eb-setting" value='{"replace_javascript_path":"3","disable_directory_listing":"on","exclude_plugins_access":"","exclude_theme_access":"","replace_wpnonce":"","replace_mode":"safe","custom_404":"0","custom_404_page":"","login_query":"hide_my_wp","admin_key":"1234","remove_feed_meta":"on","hide_admin_bar":"","remove_other_meta":"on","clean_post_class":"","remove_menu_class":"","remove_default_description":"on","remove_ver_scripts":"on","direct_access_except":"index.php, wp-comments-post.php, wp-includes/js/tinymce/wp-tinymce.php, xmlrpc.php, wp-cron.php","disable_canonical_redirect":"","email_from_name":"<?php echo get_bloginfo('blogname'); ?>","email_from_address":"<?php echo $admin_email; ?>","replace_in_html":"","new_theme_path":"/skin","new_style_name":"main.css","style_expiry_days":"3","new_include_path":"/other","new_plugin_path":"/ext","new_upload_path":"/file","replace_comments_post":"","replace_admin_ajax":"ajax","new_content_path":"inc","author_enable":"1","author_base":"profile","author_query":"profile","feed_enable":"1","feed_base":"rss","feed_query":"rss","post_enable":"1","post_base":"/blog/%year%/%monthnum%/%day%/%postname%/","post_query":"entry_id","page_enable":"1","page_base":"","page_query":"page_id","paginate_enable":"1","paginate_base":"","paginate_query":"","category_enable":"1","category_base":"","category_query":"","tag_enable":"1","tag_base":"","tag_query":"","search_enable":"1","search_base":"","search_query":"","nice_search_redirect":"on","import_options":"","export_options":"","debug_report":"","minify_new_style":"safe","clean_new_style":"","rename_plugins":"","separator2":"","author_without_base":"","disable_archive":"","disable_other_wp":"","trusted_user_roles":"","hide_wp_login":"on","hide_wp_admin":"on","spy_notifier":"","separator":"","remove_body_class":"","remove_html_comments":"","antispam":"on","avoid_direct_access":"","hide_other_wp_files":"on","enable_ids":"on","ids_level":"0","ids_admin_include":"","ids_cookie":"","log_ids_min":"5","block_ids_min":"20","full_hide":"","cdn_path":"","li":"","customized_htaccess":"","email_ids_min":"30","ids_html_fields":"","replace_in_ajax":"","blocked_ip_message":"You are blocked. Please contact site administrator if you think there is a problem.","blocked_countries":"","blocked_ips":"","help_trust_network":"on","trust_network":"on","api_base":"rest","api_query":"rest","new_login_path":"","exception_fields":"REQUEST.comment[new_line]POST.comment[new_line]REQUEST.permalink_structure[new_line]POST.permalink_structure[new_line]REQUEST.selection[new_line]POST.selection[new_line]REQUEST.content[new_line]POST.content[new_line]REQUEST.__utmz[new_line]COOKIE.__utmz[new_line]REQUEST.s_pers[new_line]COOKIE.s_pers[new_line]REQUEST.user_pass[new_line]POST.user_pass[new_line]REQUEST.pass1[new_line]POST.pass1[new_line]REQUEST.pass2[new_line]POST.pass2[new_line]REQUEST.password[new_line]POST.password[new_line]POST.hide_my_wp.%[new_line]REQUEST.hide_my_wp.%[new_line]POST.%import%[new_line]REQUEST.%import%[new_line]REQUEST.newcontent[new_line]POST.newcontent[new_line]REQUEST.remember_%"}' />
                        <a href="#" class="setup-select-button button button-primary">Select Setting</a>
                    </div>
                    <div class="setup-element-wrap">
                        <div class="setup-settings-wrap">
                        ...
                        <input style="display: none;" type="radio" name="setup-eb-setting" value='{"replace_javascript_path":"3","disable_directory_listing":"on","exclude_plugins_access":"","exclude_theme_access":"","replace_wpnonce":"","replace_mode":"safe","custom_404":"0","custom_404_page":"","hide_wp_login":"on","login_query":"hide_my_wp","admin_key":"1234","hide_wp_admin":"on","remove_feed_meta":"on","hide_admin_bar":"on","remove_other_meta":"on","remove_body_class":"on","clean_post_class":"on","remove_menu_class":"on","remove_default_description":"on","remove_html_comments":"simple","remove_ver_scripts":"on","avoid_direct_access":"on","direct_access_except":"index.php, wp-comments-post.php, wp-includes/js/tinymce/wp-tinymce.php, xmlrpc.php, wp-cron.php","hide_other_wp_files":"on","disable_canonical_redirect":"on","email_from_name":"WP Plugin Development","email_from_address":"<?php echo $admin_email; ?>","replace_in_html":"","new_theme_path":"/template","new_style_name":"main.css","style_expiry_days":"3","minify_new_style":"quick","clean_new_style":"on","new_include_path":"/template/lib","new_plugin_path":"/template/ext","rename_plugins":"all","new_upload_path":"/storage","replace_comments_post":"submit_comment.php","replace_admin_ajax":"ajax","new_content_path":"inc","author_enable":"1","author_base":"profile","author_query":"profile","author_without_base":"","feed_enable":"1","feed_base":"rss.xml","feed_query":"rss","post_enable":"1","post_base":"/blog/%year%/%monthnum%/%day%/%postname%/","post_query":"entry","page_enable":"1","page_base":"/page","page_query":"page_num","paginate_enable":"1","paginate_base":"list","paginate_query":"list","category_enable":"1","category_base":"","category_query":"category","tag_enable":"1","":"keyword","tag_query":"keyword","search_enable":"1","search_base":"find","search_query":"find","nice_search_redirect":"on","disable_archive":"on","disable_other_wp":"","import_options":"","export_options":"","debug_report":"","separator2":"","trusted_user_roles":"","antispam":"on","spy_notifier":"","separator":"","enable_ids":"on","ids_level":"1","ids_admin_include":"","ids_cookie":"","log_ids_min":"1","block_ids_min":"20","full_hide":"on","cdn_path":"","li":"b8013acc-a398-479f-8ac4-ffa47b6cd485","customized_htaccess":"","email_ids_min":"20","ids_html_fields":"","replace_in_ajax":"","blocked_ip_message":"You are blocked. Please contact site administrator if you think there is a problem.","blocked_countries":"","blocked_ips":"","help_trust_network":"on","trust_network":"on","api_base":"api","api_query":"api","new_login_path":"","exception_fields":"REQUEST.comment[new_line]POST.comment[new_line]REQUEST.permalink_structure[new_line]POST.permalink_structure[new_line]REQUEST.selection[new_line]POST.selection[new_line]REQUEST.content[new_line]POST.content[new_line]REQUEST.__utmz[new_line]COOKIE.__utmz[new_line]REQUEST.s_pers[new_line]COOKIE.s_pers[new_line]REQUEST.user_pass[new_line]POST.user_pass[new_line]REQUEST.pass1[new_line]POST.pass1[new_line]REQUEST.pass2[new_line]POST.pass2[new_line]REQUEST.password[new_line]POST.password[new_line]POST.hide_my_wp.%[new_line]REQUEST.hide_my_wp.%[new_line]POST.%import%[new_line]REQUEST.%import%[new_line]REQUEST.newcontent[new_line]POST.newcontent[new_line]REQUEST.remember_%"}' />
                        <a href="#" class="setup-select-button button button-primary">Select Setting</a>
                    </div>
...
//       }
    ...
    function callback_import($args) {
        ...
        if ($args['options']) {
            ...
            $html .= sprintf('</select>');
            $html .= '  <a href="'. home_url() . '/wp-admin/admin.php?page=hmwp_setup_wizard' .'" class="button button-primary">Open Wizard</a>';
            $html .= '<br>';
        }
