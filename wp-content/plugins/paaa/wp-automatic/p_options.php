								...
								<div class="inside main TTWForm" style="padding-bottom: 14px">
									...
									<!--start container-->
 									...
 									?>
 										...
 										<div class="field f_100 ">
 										<label> Purchase code</label> <input value="<?php   echo get_option( 'wp_automatic_license' ) ?>" name="wp_automatic_license" type="text" placeholder="Please key in 'prowebber.ru'">
