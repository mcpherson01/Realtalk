...
class WordPress_GDPR_Admin extends WordPress_GDPR
{
    ...
    public function reorder_menu_items()
    {
        ...
        if(isset($submenu['wordpress_gdpr_options_options'])) {
            ...
            $new_array['service_categories'] = isset($submenu['wordpress_gdpr_options_options'][0]) ? $submenu['wordpress_gdpr_options_options'][0] : array();
            $new_array['requests'] = isset($submenu['wordpress_gdpr_options_options'][1]) ? $submenu['wordpress_gdpr_options_options'][1] : array();
            $new_array['services'] = isset($submenu['wordpress_gdpr_options_options'][2]) ? $submenu['wordpress_gdpr_options_options'][2] : array();
            $new_array['settings'] = isset($submenu['wordpress_gdpr_options_options'][3]) ? $submenu['wordpress_gdpr_options_options'][3] : array();
