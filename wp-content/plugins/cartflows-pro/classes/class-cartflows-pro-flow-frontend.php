...
class Cartflows_Pro_Flow_Frontend {
	 ...
	 * @return int
	 */
	public function get_next_step_id_for_upsell_accepted( $flow_id, $step_id ) {
	 ...
	 * @return int
	 */
	public function get_next_step_id_for_upsell_rejected( $flow_id, $step_id ) {
	 ...
	 * @return int
	 */
	public function get_next_step_id_for_flow( $flow_id, $step_id ) {
	 ...
	 * @return int
	 */
	public function get_next_step_id_for_downsell_accepted( $flow_id, $step_id ) {
	 ...
	 * @return int
	 */
	public function get_next_step_id_for_downsell_rejected( $flow_id, $step_id ) {
	 ...
	 * @return int
	 */
	public function get_thankyou_page_id( $flow_id, $step_id ) {
