...
function get_country_code(){
    $country_code = array(
      0 => array(
          'name' => addslashes(__('Afghanistan', 'ARForms')),
          'dial_code' => '+93',
          'code' => 'af',
      ),
      1 => array(
          'name' => addslashes(__('Aland Islands', 'ARForms')),
          'dial_code' => '+358',
          'code' => 'ax',
      ),
      2 => array(
          'name' => addslashes(__('Albania', 'ARForms')),
          'dial_code' => '+355',
          'code' => 'al',
      ),
      3 => array(
          'name' => addslashes(__('Algeria', 'ARForms')),
          'dial_code' => '+213',
          'code' => 'dz',
      ),
      4 => array(
          'name' => addslashes(__('American Samoa', 'ARForms')),
          'dial_code' => '+1684',
          'code' => 'as',
      ),
      5 => array(
        'name' => addslashes(__('Andorra', 'ARForms')),
        'dial_code' => '+376',
        'code' => 'ad',
      ),
      6 => array(
        'name' => addslashes(__('Angola', 'ARForms')),
        'dial_code' => '+244',
        'code' => 'ao',
      ),
      7 => array(
      'name' => addslashes(__('Anguilla', 'ARForms')),
      'dial_code' => '+1264',
      'code' => 'ai',
      ),
      8 => array(
      'name' => addslashes(__('Antigua and Barbuda', 'ARForms')),
      'dial_code' => '+1268',
      'code' => 'ag',
      ),
      9 => array(
      'name' => addslashes(__('Argentina', 'ARForms')),
      'dial_code' => '+54',
      'code' => 'ar',
      ),
      10 => array(
      'name' => addslashes(__('Armenia', 'ARForms')),
      'dial_code' => '+374',
      'code' => 'am',
      ),
      11 => array(
      'name' => addslashes(__('Aruba', 'ARForms')),
      'dial_code' => '+297',
      'code' => 'aw',
      ),
      12 => array(
      'name' => addslashes(__('Australia', 'ARForms')),
      'dial_code' => '+61',
      'code' => 'au',
      ),
      13 => array(
      'name' => addslashes(__('Austria', 'ARForms')),
      'dial_code' => '+43',
      'code' => 'at',
      ),
      14 => array(
      'name' => addslashes(__('Azerbaijan', 'ARForms')),
      'dial_code' => '+994',
      'code' => 'az',
      ),
      15 => array(
      'name' => addslashes(__('Bahamas', 'ARForms')),
      'dial_code' => '+1242',
      'code' => 'bs',
      ),
      16 => array(
      'name' => addslashes(__('Bahrain', 'ARForms')),
      'dial_code' => '+973',
      'code' => 'bh',
      ),
      17 => array(
      'name' => addslashes(__('Bangladesh', 'ARForms')),
      'dial_code' => '+880',
      'code' => 'bd',
      ),
      18 => array(
      'name' => addslashes(__('Barbados', 'ARForms')),
      'dial_code' => '+1246',
      'code' => 'bb',
      ),
      19 => array(
      'name' => addslashes(__('Belarus', 'ARForms')),
      'dial_code' => '+375',
      'code' => 'by',
      ),
      20 => array(
      'name' => addslashes(__('Belgium', 'ARForms')),
      'dial_code' => '+32',
      'code' => 'be',
      ),
      21 => array(
      'name' => addslashes(__('Belize', 'ARForms')),
      'dial_code' => '+501',
      'code' => 'bz',
      ),
      22 => array(
      'name' => addslashes(__('Benin', 'ARForms')),
      'dial_code' => '+229',
      'code' => 'bj',
      ),
      23 => array(
      'name' => addslashes(__('Bermuda', 'ARForms')),
      'dial_code' => '+1441',
      'code' => 'bm',
      ),
      24 => array(
      'name' => addslashes(__('Bhutan', 'ARForms')),
      'dial_code' => '+975',
      'code' => 'bt',
      ),
      25 => array(
      'name' => addslashes(__('Bolivia', 'ARForms')),
      'dial_code' => '+591',
      'code' => 'bo',
      ),
      26 => array(
      'name' => addslashes(__('Bosnia and Herzegovina', 'ARForms')),
      'dial_code' => '+387',
      'code' => 'ba',
      ),
      27 => array(
      'name' => addslashes(__('Botswana', 'ARForms')),
      'dial_code' => '+267',
      'code' => 'bw',
      ),
      28 => array(
      'name' => addslashes(__('Brazil', 'ARForms')),
      'dial_code' => '+55',
      'code' => 'br',
      ),
      29 => array(
      'name' => addslashes(__('British Indian Ocean Territory', 'ARForms')),
      'dial_code' => '+246',
      'code' => 'io',
      ),
      30 => array(
      'name' => addslashes(__('British Virgin Islands', 'ARForms')),
      'dial_code' => '+1284',
      'code' => 'vg',
      ),
      31 => array(
      'name' => addslashes(__('Brunei', 'ARForms')),
      'dial_code' => '+673',
      'code' => 'bn',
      ),
      32 => array(
      'name' => addslashes(__('Bulgaria', 'ARForms')),
      'dial_code' => '+359',
      'code' => 'bg',
      ),
      33 => array(
      'name' => addslashes(__('Burkina Faso', 'ARForms')),
      'dial_code' => '+226',
      'code' => 'bf',
      ),
      34 => array(
      'name' => addslashes(__('Burundi', 'ARForms')),
      'dial_code' => '+257',
      'code' => 'bi',
      ),
      35 => array(
      'name' => addslashes(__('Cambodia', 'ARForms')),
      'dial_code' => '+855',
      'code' => 'kh',
      ),
      36 => array(
      'name' => addslashes(__('Cameroon', 'ARForms')),
      'dial_code' => '+237',
      'code' => 'cm',
      ),
      37 => array(
      'name' => addslashes(__('Canada', 'ARForms')),
      'dial_code' => '+1',
      'code' => 'ca',
      ),
      38 => array(
      'name' => addslashes(__('Cape Verde', 'ARForms')),
      'dial_code' => '+238',
      'code' => 'cv',
      ),
      39 => array(
      'name' => addslashes(__('Caribbean Netherlands', 'ARForms')),
      'dial_code' => '+599',
      'code' => 'bq',
      ),
      40 => array(
      'name' => addslashes(__('Cayman Islands', 'ARForms')),
      'dial_code' => '+1345',
      'code' => 'ky',
      ),
      41 => array(
      'name' => addslashes(__('Central African Republic', 'ARForms')),
      'dial_code' => '+236',
      'code' => 'cf',
      ),
      42 => array(
      'name' => addslashes(__('Chad', 'ARForms')),
      'dial_code' => '+235',
      'code' => 'td',
      ),
      43 => array(
      'name' => addslashes(__('Chile', 'ARForms')),
      'dial_code' => '+56',
      'code' => 'cl',
      ),
      44 => array(
      'name' => addslashes(__('China', 'ARForms')),
      'dial_code' => '+86',
      'code' => 'cn',
      ),
      45 => array(
      'name' => addslashes(__('Christmas Island', 'ARForms')),
      'dial_code' => '+61',
      'code' => 'cx',
      ),
      46 => array(
      'name' => addslashes(__('Cocos Islands', 'ARForms')),
      'dial_code' => '+61',
      'code' => 'cc',
      ),
      47 => array(
      'name' => addslashes(__('Colombia', 'ARForms')),
      'dial_code' => '+57',
      'code' => 'co',
      ),
      48 => array(
      'name' => addslashes(__('Comoros', 'ARForms')),
      'dial_code' => '+269',
      'code' => 'km',
      ),
      49 => array(
      'name' => addslashes(__('Congo (DRC)', 'ARForms')),
      'dial_code' => '+243',
      'code' => 'cd',
      ),
      50 => array(
      'name' => addslashes(__('Congo (Republic)', 'ARForms')),
      'dial_code' => '+242',
      'code' => 'cg',
      ),
      51 => array(
      'name' => addslashes(__('Cook Islands', 'ARForms')),
      'dial_code' => '+682',
      'code' => 'ck',
      ),
      52 => array(
      'name' => addslashes(__('Costa Rica', 'ARForms')),
      'dial_code' => '+506',
      'code' => 'cr',
      ),
      53 => array(
      'name' => addslashes(__('Cote d\'Ivoire', 'ARForms')),
      'dial_code' => '+225',
      'code' => 'ci',
      ),
      54 => array(
      'name' => addslashes(__('Croatia', 'ARForms')),
      'dial_code' => '+385',
      'code' => 'hr',
      ),
      55 => array(
      'name' => addslashes(__('Cuba', 'ARForms')),
      'dial_code' => '+53',
      'code' => 'cu',
      ),
      56 => array(
      'name' => addslashes(__('Curacao', 'ARForms')),
      'dial_code' => '+599',
      'code' => 'cw',
      ),
      57 => array(
      'name' => addslashes(__('Cyprus', 'ARForms')),
      'dial_code' => '+357',
      'code' => 'cy',
      ),
      58 => array(
      'name' => addslashes(__('Czech Republic', 'ARForms')),
      'dial_code' => '+420',
      'code' => 'cz',
      ),
      59 => array(
      'name' => addslashes(__('Denmark', 'ARForms')),
      'dial_code' => '+45',
      'code' => 'dk',
      ),
      60 => array(
      'name' => addslashes(__('Djibouti', 'ARForms')),
      'dial_code' => '+253',
      'code' => 'dj',
      ),
      61 => array(
      'name' => addslashes(__('Dominica', 'ARForms')),
      'dial_code' => '+1767',
      'code' => 'dm',
      ),
      62 => array(
      'name' => addslashes(__('Dominican Republic', 'ARForms')),
      'dial_code' => '+1',
      'code' => 'do',
      ),
      63 => array(
      'name' => addslashes(__('Ecuador', 'ARForms')),
      'dial_code' => '+593',
      'code' => 'ec',
      ),
      64 => array(
      'name' => addslashes(__('Egypt', 'ARForms')),
      'dial_code' => '+20',
      'code' => 'eg',
      ),
      65 => array(
      'name' => addslashes(__('El Salvador', 'ARForms')),
      'dial_code' => '+503',
      'code' => 'sv',
      ),
      66 => array(
      'name' => addslashes(__('Equatorial Guinea', 'ARForms')),
      'dial_code' => '+240',
      'code' => 'gq',
      ),
      67 => array(
      'name' => addslashes(__('Eritrea', 'ARForms')),
      'dial_code' => '+291',
      'code' => 'er',
      ),
      68 => array(
      'name' => addslashes(__('Estonia', 'ARForms')),
      'dial_code' => '+372',
      'code' => 'ee',
      ),
      69 => array(
      'name' => addslashes(__('Ethiopia', 'ARForms')),
      'dial_code' => '+251',
      'code' => 'et',
      ),
      70 => array(
      'name' => addslashes(__('Falkland Islands', 'ARForms')),
      'dial_code' => '+500',
      'code' => 'fk',
      ),
      71 => array(
      'name' => addslashes(__('Faroe Islands', 'ARForms')),
      'dial_code' => '+298',
      'code' => 'fo',
      ),
      72 => array(
      'name' => addslashes(__('Fiji', 'ARForms')),
      'dial_code' => '+679',
      'code' => 'fj',
      ),
      73 => array(
      'name' => addslashes(__('Finland', 'ARForms')),
      'dial_code' => '+358',
      'code' => 'fi',
      ),
      74 => array(
      'name' => addslashes(__('France', 'ARForms')),
      'dial_code' => '+33',
      'code' => 'fr',
      ),
      75 => array(
      'name' => addslashes(__('French Guiana', 'ARForms')),
      'dial_code' => '+594',
      'code' => 'gf',
      ),
      76 => array(
      'name' => addslashes(__('French Polynesia', 'ARForms')),
      'dial_code' => '+689',
      'code' => 'pf',
      ),
      77 => array(
      'name' => addslashes(__('Gabon', 'ARForms')),
      'dial_code' => '+241',
      'code' => 'ga',
      ),
      78 => array(
      'name' => addslashes(__('Gambia', 'ARForms')),
      'dial_code' => '+220',
      'code' => 'gm',
      ),
      79 => array(
      'name' => addslashes(__('Georgia', 'ARForms')),
      'dial_code' => '+995',
      'code' => 'ge',
      ),
      80 => array(
      'name' => addslashes(__('Germany', 'ARForms')),
      'dial_code' => '+49',
      'code' => 'de',
      ),
      81 => array(
      'name' => addslashes(__('Ghana', 'ARForms')),
      'dial_code' => '+233',
      'code' => 'gh',
      ),
      82 => array(
      'name' => addslashes(__('Gibraltar', 'ARForms')),
      'dial_code' => '+350',
      'code' => 'gi',
      ),
      83 => array(
      'name' => addslashes(__('Greece', 'ARForms')),
      'dial_code' => '+30',
      'code' => 'gr',
      ),
      84 => array(
      'name' => addslashes(__('Greenland', 'ARForms')),
      'dial_code' => '+299',
      'code' => 'gl',
      ),
      85 => array(
      'name' => addslashes(__('Grenada', 'ARForms')),
      'dial_code' => '+1473',
      'code' => 'gd',
      ),
      86 => array(
      'name' => addslashes(__('Guadeloupe', 'ARForms')),
      'dial_code' => '+590',
      'code' => 'gp',
      ),
      87 => array(
      'name' => addslashes(__('Guam', 'ARForms')),
      'dial_code' => '+1671',
      'code' => 'gu',
      ),
      88 => array(
      'name' => addslashes(__('Guatemala', 'ARForms')),
      'dial_code' => '+502',
      'code' => 'gt',
      ),
      89 => array(
      'name' => addslashes(__('Guernsey', 'ARForms')),
      'dial_code' => '+44',
      'code' => 'gg',
      ),
      90 => array(
      'name' => addslashes(__('Guinea', 'ARForms')),
      'dial_code' => '+224',
      'code' => 'gn',
      ),
      91 => array(
      'name' => addslashes(__('Guinea-Bissau', 'ARForms')),
      'dial_code' => '+245',
      'code' => 'gw',
      ),
      92 => array(
      'name' => addslashes(__('Guyana', 'ARForms')),
      'dial_code' => '+592',
      'code' => 'gy',
      ),
      93 => array(
      'name' => addslashes(__('Haiti', 'ARForms')),
      'dial_code' => '+509',
      'code' => 'ht',
      ),
      94 => array(
      'name' => addslashes(__('Honduras', 'ARForms')),
      'dial_code' => '+504',
      'code' => 'hn',
      ),
      95 => array(
      'name' => addslashes(__('Hong Kong', 'ARForms')),
      'dial_code' => '+852',
      'code' => 'hk',
      ),
      96 => array(
      'name' => addslashes(__('Hungary', 'ARForms')),
      'dial_code' => '+36',
      'code' => 'hu',
      ),
      97 => array(
      'name' => addslashes(__('Iceland', 'ARForms')),
      'dial_code' => '+354',
      'code' => 'is',
      ),
      98 => array(
      'name' => addslashes(__('India', 'ARForms')),
      'dial_code' => '+91',
      'code' => 'in',
      ),
      99 => array(
      'name' => addslashes(__('Indonesia', 'ARForms')),
      'dial_code' => '+62',
      'code' => 'id',
      ),
      100 => array(
      'name' => addslashes(__('Iran', 'ARForms')),
      'dial_code' => '+98',
      'code' => 'ir',
      ),
      101 => array(
      'name' => addslashes(__('Iraq', 'ARForms')),
      'dial_code' => '+964',
      'code' => 'iq',
      ),
      102 => array(
      'name' => addslashes(__('Ireland', 'ARForms')),
      'dial_code' => '+353',
      'code' => 'ie',
      ),
      103 => array(
      'name' => addslashes(__('Isle of Man', 'ARForms')),
      'dial_code' => '+44',
      'code' => 'im',
      ),
      104 => array(
      'name' => addslashes(__('Israel', 'ARForms')),
      'dial_code' => '+972',
      'code' => 'il',
      ),
      105 => array(
      'name' => addslashes(__('Italy', 'ARForms')),
      'dial_code' => '+39',
      'code' => 'it',
      ),
      106 => array(
      'name' => addslashes(__('Jamaica', 'ARForms')),
      'dial_code' => '+1',
      'code' => 'jm',
      ),
      107 => array(
      'name' => addslashes(__('Japan', 'ARForms')),
      'dial_code' => '+81',
      'code' => 'jp',
      ),
      108 => array(
      'name' => addslashes(__('Jersey', 'ARForms')),
      'dial_code' => '+44',
      'code' => 'je',
      ),
      109 => array(
      'name' => addslashes(__('Jordan', 'ARForms')),
      'dial_code' => '+962',
      'code' => 'jo',
      ),
      110 => array(
      'name' => addslashes(__('Kazakhstan', 'ARForms')),
      'dial_code' => '+7',
      'code' => 'kz',
      ),
      111 => array(
      'name' => addslashes(__('Kenya', 'ARForms')),
      'dial_code' => '+254',
      'code' => 'ke',
      ),
      112 => array(
      'name' => addslashes(__('Kiribati', 'ARForms')),
      'dial_code' => '+686',
      'code' => 'ki',
      ),
      113 => array(
      'name' => addslashes(__('Kosovo', 'ARForms')),
      'dial_code' => '+383',
      'code' => 'xk',
      ),
      114 => array(
      'name' => addslashes(__('Kuwait', 'ARForms')),
      'dial_code' => '+965',
      'code' => 'kw',
      ),
      115 => array(
      'name' => addslashes(__('Kyrgyzstan', 'ARForms')),
      'dial_code' => '+996',
      'code' => 'kg',
      ),
      116 => array(
      'name' => addslashes(__('Laos', 'ARForms')),
      'dial_code' => '+856',
      'code' => 'la',
      ),
      117 => array(
      'name' => addslashes(__('Latvia', 'ARForms')),
      'dial_code' => '+371',
      'code' => 'lv',
      ),
      118 => array(
      'name' => addslashes(__('Lebanon', 'ARForms')),
      'dial_code' => '+961',
      'code' => 'lb',
      ),
      119 => array(
      'name' => addslashes(__('Lesotho', 'ARForms')),
      'dial_code' => '+266',
      'code' => 'ls',
      ),
      120 => array(
      'name' => addslashes(__('Liberia', 'ARForms')),
      'dial_code' => '+231',
      'code' => 'lr',
      ),
      121 => array(
      'name' => addslashes(__('Libya', 'ARForms')),
      'dial_code' => '+218',
      'code' => 'ly',
      ),
      122 => array(
      'name' => addslashes(__('Liechtenstein', 'ARForms')),
      'dial_code' => '+423',
      'code' => 'li',
      ),
      123 => array(
      'name' => addslashes(__('Lithuania', 'ARForms')),
      'dial_code' => '+370',
      'code' => 'lt',
      ),
      124 => array(
      'name' => addslashes(__('Luxembourg', 'ARForms')),
      'dial_code' => '+352',
      'code' => 'lu',
      ),
      125 => array(
      'name' => addslashes(__('Macau', 'ARForms')),
      'dial_code' => '+853',
      'code' => 'mo',
      ),
      126 => array(
      'name' => addslashes(__('Macedonia', 'ARForms')),
      'dial_code' => '+389',
      'code' => 'mk',
      ),
      127 => array(
      'name' => addslashes(__('Madagascar', 'ARForms')),
      'dial_code' => '+261',
      'code' => 'mg',
      ),
      128 => array(
      'name' => addslashes(__('Malawi', 'ARForms')),
      'dial_code' => '+265',
      'code' => 'mw',
      ),
      129 => array(
      'name' => addslashes(__('Malaysia', 'ARForms')),
      'dial_code' => '+60',
      'code' => 'my',
      ),
      130 => array(
      'name' => addslashes(__('Maldives', 'ARForms')),
      'dial_code' => '+960',
      'code' => 'mv',
      ),
      131 => array(
      'name' => addslashes(__('Mali', 'ARForms')),
      'dial_code' => '+223',
      'code' => 'ml',
      ),
      132 => array(
      'name' => addslashes(__('Malta', 'ARForms')),
      'dial_code' => '+356',
      'code' => 'mt',
      ),
      133 => array(
      'name' => addslashes(__('Marshall Islands', 'ARForms')),
      'dial_code' => '+692',
      'code' => 'mh',
      ),
      134 => array(
      'name' => addslashes(__('Martinique', 'ARForms')),
      'dial_code' => '+596',
      'code' => 'mq',
      ),
      135 => array(
      'name' => addslashes(__('Mauritania', 'ARForms')),
      'dial_code' => '+222',
      'code' => 'mr',
      ),
      136 => array(
      'name' => addslashes(__('Mauritius', 'ARForms')),
      'dial_code' => '+230',
      'code' => 'mu',
      ),
      137 => array(
      'name' => addslashes(__('Mayotte', 'ARForms')),
      'dial_code' => '+262',
      'code' => 'yt',
      ),
      138 => array(
      'name' => addslashes(__('Mexico', 'ARForms')),
      'dial_code' => '+52',
      'code' => 'mx',
      ),
      139 => array(
      'name' => addslashes(__('Micronesia', 'ARForms')),
      'dial_code' => '+691',
      'code' => 'fm',
      ),
      140 => array(
      'name' => addslashes(__('Moldova', 'ARForms')),
      'dial_code' => '+373',
      'code' => 'md',
      ),
      141 => array(
      'name' => addslashes(__('Monaco', 'ARForms')),
      'dial_code' => '+377',
      'code' => 'mc',
      ),
      142 => array(
      'name' => addslashes(__('Mongolia', 'ARForms')),
      'dial_code' => '+976',
      'code' => 'mn',
      ),
      143 => array(
      'name' => addslashes(__('Montenegro', 'ARForms')),
      'dial_code' => '+382',
      'code' => 'me',
      ),
      144 => array(
      'name' => addslashes(__('Montserrat', 'ARForms')),
      'dial_code' => '+1664',
      'code' => 'ms',
      ),
      145 => array(
      'name' => addslashes(__('Morocco', 'ARForms')),
      'dial_code' => '+212',
      'code' => 'ma',
      ),
      146 => array(
      'name' => addslashes(__('Mozambique', 'ARForms')),
      'dial_code' => '+258',
      'code' => 'mz',
      ),
      147 => array(
      'name' => addslashes(__('Myanmar', 'ARForms')),
      'dial_code' => '+95',
      'code' => 'mm',
      ),
      148 => array(
      'name' => addslashes(__('Namibia', 'ARForms')),
      'dial_code' => '+264',
      'code' => 'na',
      ),
      149 => array(
      'name' => addslashes(__('Nauru', 'ARForms')),
      'dial_code' => '+674',
      'code' => 'nr',
      ),
      150 => array(
      'name' => addslashes(__('Nepal', 'ARForms')),
      'dial_code' => '+977',
      'code' => 'np',
      ),
      151 => array(
      'name' => addslashes(__('Netherlands', 'ARForms')),
      'dial_code' => '+31',
      'code' => 'nl',
      ),
      152 => array(
      'name' => addslashes(__('New Caledonia', 'ARForms')),
      'dial_code' => '+687',
      'code' => 'nc',
      ),
      153 => array(
      'name' => addslashes(__('New Zealand', 'ARForms')),
      'dial_code' => '+64',
      'code' => 'nz',
      ),
      154 => array(
      'name' => addslashes(__('Nicaragua', 'ARForms')),
      'dial_code' => '+505',
      'code' => 'ni',
      ),
      155 => array(
      'name' => addslashes(__('Niger', 'ARForms')),
      'dial_code' => '+227',
      'code' => 'ne',
      ),
      156 => array(
      'name' => addslashes(__('Nigeria', 'ARForms')),
      'dial_code' => '+234',
      'code' => 'ng',
      ),
      157 => array(
      'name' => addslashes(__('Niue', 'ARForms')),
      'dial_code' => '+683',
      'code' => 'nu',
      ),
      158 => array(
      'name' => addslashes(__('Norfolk Island', 'ARForms')),
      'dial_code' => '+672',
      'code' => 'nf',
      ),
      159 => array(
      'name' => addslashes(__('North Korea', 'ARForms')),
      'dial_code' => '+850',
      'code' => 'kp',
      ),
      160 => array(
      'name' => addslashes(__('Northern Mariana Islands', 'ARForms')),
      'dial_code' => '+1670',
      'code' => 'mp',
      ),
      161 => array(
      'name' => addslashes(__('Norway', 'ARForms')),
      'dial_code' => '+47',
      'code' => 'no',
      ),
      162 => array(
      'name' => addslashes(__('Oman', 'ARForms')),
      'dial_code' => '+968',
      'code' => 'om',
      ),
      163 => array(
      'name' => addslashes(__('Pakistan', 'ARForms')),
      'dial_code' => '+92',
      'code' => 'pk',
      ),
      164 => array(
      'name' => addslashes(__('Palau', 'ARForms')),
      'dial_code' => '+680',
      'code' => 'pw',
      ),
      165 => array(
      'name' => addslashes(__('Palestine', 'ARForms')),
      'dial_code' => '+970',
      'code' => 'ps',
      ),
      166 => array(
      'name' => addslashes(__('Panama', 'ARForms')),
      'dial_code' => '+507',
      'code' => 'pa',
      ),
      167 => array(
      'name' => addslashes(__('Papua New Guinea', 'ARForms')),
      'dial_code' => '+675',
      'code' => 'pg',
      ),
      168 => array(
      'name' => addslashes(__('Paraguay', 'ARForms')),
      'dial_code' => '+595',
      'code' => 'py',
      ),
      169 => array(
      'name' => addslashes(__('Peru', 'ARForms')),
      'dial_code' => '+51',
      'code' => 'pe',
      ),
      170 => array(
      'name' => addslashes(__('Philippines', 'ARForms')),
      'dial_code' => '+63',
      'code' => 'ph',
      ),
      171 => array(
      'name' => addslashes(__('Poland', 'ARForms')),
      'dial_code' => '+48',
      'code' => 'pl',
      ),
      172 => array(
      'name' => addslashes(__('Portugal', 'ARForms')),
      'dial_code' => '+351',
      'code' => 'pt',
      ),
      173 => array(
      'name' => addslashes(__('Puerto Rico', 'ARForms')),
      'dial_code' => '+1',
      'code' => 'pr',
      ),
      174 => array(
      'name' => addslashes(__('Qatar', 'ARForms')),
      'dial_code' => '+974',
      'code' => 'qa',
      ),
      175 => array(
      'name' => addslashes(__('Reunion', 'ARForms')),
      'dial_code' => '+262',
      'code' => 're',
      ),
      176 => array(
      'name' => addslashes(__('Romania', 'ARForms')),
      'dial_code' => '+40',
      'code' => 'ro',
      ),
      177 => array(
      'name' => addslashes(__('Russia', 'ARForms')),
      'dial_code' => '+7',
      'code' => 'ru',
      ),
      178 => array(
      'name' => addslashes(__('Rwanda', 'ARForms')),
      'dial_code' => '+250',
      'code' => 'rw',
      ),
      179 => array(
      'name' => addslashes(__('Saint Barthelemy', 'ARForms')),
      'dial_code' => '+590',
      'code' => 'bl',
      ),
      180 => array(
      'name' => addslashes(__('Saint Helena', 'ARForms')),
      'dial_code' => '+290',
      'code' => 'sh',
      ),
      181 => array(
      'name' => addslashes(__('Saint Kitts and Nevis', 'ARForms')),
      'dial_code' => '+1869',
      'code' => 'kn',
      ),
      182 => array(
      'name' => addslashes(__('Saint Lucia', 'ARForms')),
      'dial_code' => '+1758',
      'code' => 'lc',
      ),
      183 => array(
      'name' => addslashes(__('Saint Martin', 'ARForms')),
      'dial_code' => '+590',
      'code' => 'mf',
      ),
      184 => array(
      'name' => addslashes(__('Saint Pierre and Miquelon', 'ARForms')),
      'dial_code' => '+508',
      'code' => 'pm',
      ),
      185 => array(
      'name' => addslashes(__('Saint Vincent and the Grenadines', 'ARForms')),
      'dial_code' => '+1784',
      'code' => 'vc',
      ),
      186 => array(
      'name' => addslashes(__('Samoa', 'ARForms')),
      'dial_code' => '+685',
      'code' => 'ws',
      ),
      187 => array(
      'name' => addslashes(__('San Marino', 'ARForms')),
      'dial_code' => '+378',
      'code' => 'sm',
      ),
      188 => array(
      'name' => addslashes(__('Sao Tome and Principe', 'ARForms')),
      'dial_code' => '+239',
      'code' => 'st',
      ),
      189 => array(
      'name' => addslashes(__('Saudi Arabia', 'ARForms')),
      'dial_code' => '+966',
      'code' => 'sa',
      ),
      190 => array(
      'name' => addslashes(__('Senegal', 'ARForms')),
      'dial_code' => '+221',
      'code' => 'sn',
      ),
      191 => array(
      'name' => addslashes(__('Serbia', 'ARForms')),
      'dial_code' => '+381',
      'code' => 'rs',
      ),
      192 => array(
      'name' => addslashes(__('Seychelles', 'ARForms')),
      'dial_code' => '+248',
      'code' => 'sc',
      ),
      193 => array(
      'name' => addslashes(__('Sierra Leone', 'ARForms')),
      'dial_code' => '+232',
      'code' => 'sl',
      ),
      194 => array(
      'name' => addslashes(__('Singapore', 'ARForms')),
      'dial_code' => '+65',
      'code' => 'sg',
      ),
      195 => array(
      'name' => addslashes(__('Sint Maarten', 'ARForms')),
      'dial_code' => '+1721',
      'code' => 'sx',
      ),
      196 => array(
      'name' => addslashes(__('Slovakia', 'ARForms')),
      'dial_code' => '+421',
      'code' => 'sk',
      ),
      197 => array(
      'name' => addslashes(__('Slovenia', 'ARForms')),
      'dial_code' => '+386',
      'code' => 'si',
      ),
      198 => array(
      'name' => addslashes(__('Solomon Islands', 'ARForms')),
      'dial_code' => '+677',
      'code' => 'sb',
      ),
      199 => array(
      'name' => addslashes(__('Somalia', 'ARForms')),
      'dial_code' => '+252',
      'code' => 'so',
      ),
      200 => array(
      'name' => addslashes(__('South Africa', 'ARForms')),
      'dial_code' => '+27',
      'code' => 'za',
      ),
      201 => array(
      'name' => addslashes(__('South Korea', 'ARForms')),
      'dial_code' => '+82',
      'code' => 'kr',
      ),
      202 => array(
      'name' => addslashes(__('South Sudan', 'ARForms')),
      'dial_code' => '+211',
      'code' => 'ss',
      ),
      203 => array(
      'name' => addslashes(__('Spain', 'ARForms')),
      'dial_code' => '+34',
      'code' => 'es',
      ),
      204 => array(
      'name' => addslashes(__('Sri Lanka', 'ARForms')),
      'dial_code' => '+94',
      'code' => 'lk',
      ),
      205 => array(
      'name' => addslashes(__('Sudan', 'ARForms')),
      'dial_code' => '+249',
      'code' => 'sd',
      ),
      206 => array(
      'name' => addslashes(__('Suriname', 'ARForms')),
      'dial_code' => '+597',
      'code' => 'sr',
      ),
      207 => array(
      'name' => addslashes(__('Svalbard and Jan Mayen', 'ARForms')),
      'dial_code' => '+47',
      'code' => 'sj',
      ),
      208 => array(
      'name' => addslashes(__('Swaziland', 'ARForms')),
      'dial_code' => '+268',
      'code' => 'sz',
      ),
      209 => array(
      'name' => addslashes(__('Sweden', 'ARForms')),
      'dial_code' => '+46',
      'code' => 'se',
      ),
      210 => array(
      'name' => addslashes(__('Switzerland', 'ARForms')),
      'dial_code' => '+41',
      'code' => 'ch',
      ),
      211 => array(
      'name' => addslashes(__('Syria', 'ARForms')),
      'dial_code' => '+963',
      'code' => 'sy',
      ),
      212 => array(
      'name' => addslashes(__('Taiwan', 'ARForms')),
      'dial_code' => '+886',
      'code' => 'tw',
      ),
      213 => array(
      'name' => addslashes(__('Tajikistan', 'ARForms')),
      'dial_code' => '+992',
      'code' => 'tj',
      ),
      214 => array(
      'name' => addslashes(__('Tanzania', 'ARForms')),
      'dial_code' => '+255',
      'code' => 'tz',
      ),
      215 => array(
      'name' => addslashes(__('Thailand', 'ARForms')),
      'dial_code' => '+66',
      'code' => 'th',
      ),
      216 => array(
      'name' => addslashes(__('Timor-Leste', 'ARForms')),
      'dial_code' => '+670',
      'code' => 'tl',
      ),
      217 => array(
      'name' => addslashes(__('Togo', 'ARForms')),
      'dial_code' => '+228',
      'code' => 'tg',
      ),
      218 => array(
      'name' => addslashes(__('Tokelau', 'ARForms')),
      'dial_code' => '+690',
      'code' => 'tk',
      ),
      219 => array(
      'name' => addslashes(__('Tonga', 'ARForms')),
      'dial_code' => '+676',
      'code' => 'to',
      ),
      220 => array(
      'name' => addslashes(__('Trinidad and Tobago', 'ARForms')),
      'dial_code' => '+1868',
      'code' => 'tt',
      ),
      221 => array(
      'name' => addslashes(__('Tunisia', 'ARForms')),
      'dial_code' => '+216',
      'code' => 'tn',
      ),
      222 => array(
      'name' => addslashes(__('Turkey', 'ARForms')),
      'dial_code' => '+90',
      'code' => 'tr',
      ),
      223 => array(
      'name' => addslashes(__('Turkmenistan', 'ARForms')),
      'dial_code' => '+993',
      'code' => 'tm',
      ),
      224 => array(
      'name' => addslashes(__('Turks and Caicos Islands', 'ARForms')),
      'dial_code' => '+1649',
      'code' => 'tc',
      ),
      225 => array(
      'name' => addslashes(__('Tuvalu', 'ARForms')),
      'dial_code' => '+688',
      'code' => 'tv',
      ),
      226 => array(
      'name' => addslashes(__('U.S. Virgin Islands', 'ARForms')),
      'dial_code' => '+1340',
      'code' => 'vi',
      ),
      227 => array(
      'name' => addslashes(__('Uganda', 'ARForms')),
      'dial_code' => '+256',
      'code' => 'ug',
      ),
      228 => array(
      'name' => addslashes(__('Ukraine', 'ARForms')),
      'dial_code' => '+380',
      'code' => 'ua',
      ),
      229 => array(
      'name' => addslashes(__('United Arab Emirates', 'ARForms')),
      'dial_code' => '+971',
      'code' => 'ae',
      ),
      230 => array(
      'name' => addslashes(__('United Kingdom', 'ARForms')),
      'dial_code' => '+44',
      'code' => 'gb',
      ),
      231 => array(
      'name' => addslashes(__('United States', 'ARForms')),
      'dial_code' => '+1',
      'code' => 'us',
      ),
      232 => array(
      'name' => addslashes(__('Uruguay', 'ARForms')),
      'dial_code' => '+598',
      'code' => 'uy',
      ),
      233 => array(
      'name' => addslashes(__('Uzbekistan', 'ARForms')),
      'dial_code' => '+998',
      'code' => 'uz',
      ),
      234 => array(
      'name' => addslashes(__('Vanuatu', 'ARForms')),
      'dial_code' => '+678',
      'code' => 'vu',
      ),
      235 => array(
      'name' => addslashes(__('Vatican City', 'ARForms')),
      'dial_code' => '+39',
      'code' => 'va',
      ),
      236 => array(
      'name' => addslashes(__('Venezuela', 'ARForms')),
      'dial_code' => '+58',
      'code' => 've',
      ),
      237 => array(
      'name' => addslashes(__('Vietnam', 'ARForms')),
      'dial_code' => '+84',
      'code' => 'vn',
      ),
      238 => array(
      'name' => addslashes(__('Wallis and Futuna', 'ARForms')),
      'dial_code' => '+681',
      'code' => 'wf',
      ),
      239 => array(
      'name' => addslashes(__('Western Sahara', 'ARForms')),
      'dial_code' => '+212',
      'code' => 'eh',
      ),
      240 => array(
      'name' => addslashes(__('Yemen', 'ARForms')),
      'dial_code' => '+967',
      'code' => 'ye',
      ),
      241 => array(
      'name' => addslashes(__('Zambia', 'ARForms')),
      'dial_code' => '+260',
      'code' => 'zm',
      ),
      242 => array(
      'name' => addslashes(__('Zimbabwe', 'ARForms')),
      'dial_code' => '+263',
      'code' => 'zw',
      ),
  );
