                                        ...
                                        <div class="arf_accordion_container_row" style="height: auto;">
                                            ...
                                            <div class="arf_customize_color_div arf_right" style="width:100%;">
                                                <div class="arf_customize_color_inner_label_div">
                                                    <div class='arf_accordion_inner_title arf_label_custom_color' style="width: 90%;"><?php echo addslashes(__('Custom Color', 'ARForms')); ?></div>
                                                </div>
                                                <div class="arf_customize_color_inner_control_div">
                                                    ...
                                                    <div class="arf_custom_color" style="width: 102px;">
                                                        ...
                                                        <div class="arf_custom_color_label" style="width: 70px;"><?php echo addslashes(__('Custom', 'ARForms')); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="arf_accordion_container_row arf_accordion_container_row_input_size" >
                                            ...
                                            <div class="arf_right arfmarginright">
                                                <div class="arf_custom_font" style="margin-top: 20px;">
                                                    ...
                                                    <div class="arf_custom_font_label"><?php echo addslashes(__('Advanced font options', 'ARForms')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <dd>
                                    ...
                                    <div class="arf_accordion_container">
                                        ...
                                        <div class="arf_accordion_container_row arf_half_width <?php echo $arf_bg_position_height_style_x; ?>" style="margin-bottom: 30px;">
                                            <div style="width: 31% !important;" class="arf_accordion_inner_title arf_form_padding arf_two_row_text"><?php echo addslashes(__('Background Image Position-X', 'ARForms')); ?></div>
                                            <div class="arf_form_bg_position_container">
                                                ...
                                                <div class="arf_dropdown_wrapper" style="width: 100%;">
                                                    ...
                                                    <span class="arf_px arf_font_size" style="margin-left: 10px;position: relative;"><?php echo addslashes(__('X-axis', 'ARForms')); ?></span>
                                                </div>  
                                            ...
                                            <div class="arf_form_bg_position_input_container">
                                                <div class="arf_form_bg_position_input_div" id="arf_form_bg_position_input_div_x" style="margin-left:14px; margin-right: -5px;<?php echo $arf_bg_position_style_x; ?>">
                                                    ...
                                                    <span class="arf_px arf_font_size" style="margin-left: 10px;"><?php echo addslashes(__('X-axis', 'ARForms')); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="arf_accordion_container_row arf_half_width <?php echo $arf_bg_position_height_style_y; ?>" style="margin-bottom: 30px;">
                                            <div style="width: 31% !important;" class="arf_accordion_inner_title arf_form_padding arf_two_row_text"><?php echo addslashes(__('Background Image Position-Y', 'ARForms')); ?></div>
                                            ...
                                            ?>
                                                <div class="arf_dropdown_wrapper" style="width: 100%;">
                                                    ...
                                                    <span class="arf_px arf_font_size" style="margin-left: 10px;position: relative;"><?php echo addslashes(__('Y-axis', 'ARForms')); ?></span>
                                                </div>
                                            </div>
                                            
                                            <div class="arf_form_bg_position_input_container">
                                                <div class="arf_form_bg_position_input_div" id="arf_form_bg_position_input_div_y" style="margin-right: 12px;<?php echo $arf_bg_position_style_y; ?>">
                                                    ...
                                                    <span class="arf_px arf_font_size" style="margin-left: 10px;"><?php echo addslashes(__('Y-axis', 'ARForms')); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="arf_accordion_container_row arf_half_width" style="height: 70px;">
                                            ...
                                            <div class="arf_accordion_container_inner_div">
                                                <div class="arf_custom_font" data-id="arf_input_font_settings">
                                                    ...
                                                    <div class="arf_custom_font_label"><?php echo addslashes(__('Advanced font options','ARForms')); ?></div>
                                                </div>
                                            </div>
                    ...
                    <div class="arf_auto_responder_content arfmarginl10" >
                        ...
                        <div class="arf_auto_responder_row">
                            ...
                            <div style="margin-top: 5px;">
                                ...
                                <div><label><code>[ARF_page_url]</code> - <?php echo __('This will be replaced with current form\'s page URL.', 'ARForms'); ?></label></div>
                ...
                <div class="arf_popup_content_container arf_other_options_container">
                    ...
                    <div class="arf_hidden_fields_wrapper">
                        ...
                        <div class="arf_hidden_field_note">
                            <div><?php echo addslashes(__('Note','ARForms')).': '.__('These fields will not shown in the form. Enter the value to be hidden','ARForms'); ?></div>

                            <div>[ARF_current_user_id] : <?php echo addslashes(__('This shortcode replace the value with currently logged-in User ID.', 'ARForms')); ?></div>
                            <div>[ARF_current_user_name] : <?php echo addslashes(__('This shortcode replace the value with currently logged-in User Name.', 'ARForms')); ?></div>
                            <div>[ARF_current_user_email] : <?php echo addslashes(__('This shortcode replace the value with currently logged-in User Email.', 'ARForms')); ?></div>
                            <div>[ARF_current_date] : <?php echo addslashes(__('This shortcode replace the value with current Date.', 'ARForms')); ?></div>
