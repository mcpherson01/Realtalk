...
class arf_modal_view_in_menu {
    ...
    <script data-cfasync="false">
        ...
        jQuery(document).ready(function(){
         ...
         function create_menu_item_meta_box(menu_item_type,menu_item_id) {
            ...
            meta_box_html += '<b><?php echo addslashes(__('Show Full Screen Modal', 'ARForms')); ?></b>&nbsp;&nbsp;';
            ...
            meta_box_html += '<label for="arf_full_scrn_yes-[ARF_MENU_ITEM_ID]"><?php echo addslashes(__('Yes', 'ARForms')); ?></label>&nbsp;&nbsp;';
            ...
            meta_box_html += '<label for="arf_full_scrn_no-[ARF_MENU_ITEM_ID]"><?php echo addslashes(__('No', 'ARForms')); ?></label>';
                    ...
                    if( preg_match('/arfaction=(arf_modal_view_menu)/',$href) ){
                        ...
                        if (!empty($arf_menu_array)) {
                            if (array_key_exists('id', $arf_menu_array) && !empty($arf_menu_array['id'])) {
                                ...
                                echo '<span id="arf_nav_menu_link_'.$this->arf_id.'" style="display:none;">' .
                                do_shortcode('['
    ...
    function arf_add_nav_menu_metabox(){
            add_meta_box( 'arformnav', addslashes(__( 'ARForms Forms','ARForms' )), array(&$this, 'arf_from_menu_metabox'), 'nav-menus', 'side', 'default' );
            ?>
            <style type="text/css">
    ...
    function arf_from_menu_metabox($object){
            ...
            <div id="login-links" class="loginlinksdiv posttypediv">
                <div><?php echo addslashes(__("<p style='color:red;'>NOTE: This feature will only work with those themes which has support of wordpress' navigation menu core hooks.</p>", 'ARForms'));?></div>
                <p><?php echo addslashes(__("This navigation menu link will open ARForms form in Modal Window.", 'ARForms'));?></p>
                ...
                <p class="button-controls">
                    <span class="list-controls">
                        ...
                        ?>#arformnav" class="select-all"><?php echo addslashes(__( 'Select All','ARForms' )); ?></a>
                    </span>

                    <span class="add-to-menu">
                        <input type="submit"<?php disabled( $nav_menu_selected_id, 0 ); ?> class="button-secondary submit-add-to-menu right" value="<?php echo esc_attr(addslashes(__( 'Add to Menu','ARForms' ))); ?>" name="add-login-links-menu-item" id="submit-login-links" />
...
<?php
            ...
            echo addslashes(__('No Form Created Yet.','ARForms'));
        }
    }
