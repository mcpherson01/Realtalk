...
$arf_smiley_new_field_data = array(ARF_SMILEY_SLUG => addslashes(__('Smiley', 'ARForms')));
...
class arf_smiley_field {
    ...
    function arf_product_createfield($field_data) {
        ...
        if ($field_data['type'] == ARF_SMILEY_SLUG) {
            $field_data['name'] = addslashes(__('Smiley', 'ARForms'));
        }
        return $field_data;
    }
    ...
    function add_smiley_field_to_editor($field) {
        ...
        ?>
            <style> 
                .arf_smiley_container .arf_smiley_btn{display: inline-block; margin: 0 8px 0 0;}
            ...
            <?php
                if (!empty($field['arf_smiley_images_array'])) {
                    ...
                    foreach ($as_arf_smiley_images as $key => $value) {
                        ...
                        <label id="smiley_<?php echo $field['id'] . '_' . $key; ?>" class="arf_smiley_btn arfhelptip" for="field_<?php echo $field['id'] . '_' . $key; ?>" title="<?php echo esc_attr($as_arf_smiley_title[$key]); ?>">
                            ...
                            <?php } else { ?>
                                <span class="arf_smiley_icon"><i class="arfa arfa-2x <?php echo $value; ?>"></i></span>
                            <?php } ?>
                        </label>
                    <?php } ?>
                <?php } ?>
        ...
        if ($field['type'] == ARF_SMILEY_SLUG) {
            ...
            if (!empty($field['arf_smiley_images_array'])) {
                ...
                foreach ($as_arf_smiley_images as $key => $value) {
                    ...
                    $return_string .='<label id="smiley_' . $field['field_key'] . '-' . $key . '" class="arf_smiley_btn"  data-form-data-id="' . $arf_data_uniq_id . '" data-id="' . $field['id'] . '" for="field_' . $field['field_key'] . '_' . $arf_data_uniq_id . '_' . $key . '" data-title="' . esc_attr($as_arf_smiley_title[$key]) . '" '.(($as_arf_smiley_type[$key] != "image")?"style='vertical-align:bottom'":"").'>';
                    ...
                    if ($as_arf_smiley_type[$key] == 'image') {
                        ...
                        $return_string .='<span class="arf_smiley_icon"><i class="' . $value . ' arfa-2x "></i></span>';
                    }
                    $return_string .='</label>';
                }
            }
        ...
        switch ($option) {
            ...
            case 'arf_smiley_images':
                ...
                <table style="float:left; width: 100%; margin:15px 0 5px 0;" border="0" cellpadding="0" cellspacing="0" >
                    <tr class="fieldoptions_label_style"><td><?php echo addslashes(__('Smiley Images', 'ARForms')); ?>:</td></tr>
                                            ...
                                            <li class="arf_smiley_images_content" style="float:left; width: 100%; margin: 5px 0 5px 0;">
                                                ...
                                                <div style="float:left;width:19%;">
                                                    ...
                                                    <div class="arfajaxfileupload arf_smiley_fileupload" style="position: relative; overflow: hidden; float:left; cursor: pointer;">
                                                        ...
                                                        <?php echo addslashes(__('Add Image', 'ARForms')); ?>
                                                ...
                                                <div style="float:left;width:14%;">
                                                    <button field-id="<?php echo $field['id']; ?>" data-field="arf_smiley_icon" data-id="<?php echo $key; ?>" type="button" class="arf_smiley_add_btn arf_smiley_icon_btn"  href="#arf_fontawesome_modal" data-toggle="arfmodal"><?php echo addslashes(__('Add Icon', 'ARForms')); ?></button>
                                                </div>
    ...
    function arf_add_new_smiley_image() {
        ...
        <li class="arf_smiley_images_content" style="float:left; width: 100%; margin: 5px 0 5px 0;">
            ...
            <div style="float:left;width:14%;">
                <button field-id="<?php echo $field_id; ?>" data-field="arf_smiley_icon" data-id="<?php echo $key; ?>" type="button" class="arf_smiley_add_btn arf_smiley_icon_btn"  href="#arf_fontawesome_modal" data-toggle="arfmodal"><?php echo addslashes(__('Add Icon', 'ARForms')); ?></button>
            </div>
    ...
    function arf_add_smiley_field_options() {
        ...
        <div class="arf_field_option_content_cell arf_full_width_cell" id="arf_smiley_images">
            <label class="arf_field_option_content_cell_label"><?php echo addslashes(__('Smiley Images', 'ARForms')); ?></label>
