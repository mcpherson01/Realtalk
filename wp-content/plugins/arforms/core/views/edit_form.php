        ...
        <div id="arf_fieldset_<?php echo $id; ?>" class="arf_fieldset <?php echo $frm_class; ?>">
            <div id="success_message" class="arf_success_message">
                <div class="message_descripiton">
                    <div style="float: left; margin-right: 15px;"><?php echo addslashes(__('Form is successfully updated', 'ARForms')); ?></div>
            ...
            <div id="error_message" class="arf_error_message">
                <div class="message_descripiton">
                    <div style="float: left; margin-right: 15px;"><?php echo addslashes(__('Form is not successfully updated','ARForms')); ?></div>
                    <div class="message_svg_icon">
                ...
                <div id="form_desc" class="edit_form_item arffieldbox frm_head_box">
                    ...
                    <div class="arfformdescriptiondiv">
                        <div class="arfdescriptionedit">
                            ...
                            <div class="arfeditorformdescription arf_edit_in_place formdescription_style"><input type="text" data-default-value="<?php echo ($values['description'] != '') ? stripslashes_deep($values['description']) : addslashes(__('Click here to enter form description', 'ARForms')); ?>" class="arf_edit_in_place_input inplace_field" data-ajax="false" name="description" data-action="arfupdateformdescription" value="<?php echo ($values['description'] != '') ? stripslashes_deep($values['description']) : ""; ?>" placeholder="<?php echo addslashes(__('Click here to enter form description', 'ARForms'));?>"/></div>
                        </div>
            ...
            <div class="arfeditorsubmitdiv arf_submit_div top_container">
                ...
                <div class="arfsubmiteditpencil arfhelptip" title="<?php echo addslashes(__('Edit Text', 'ARForms')); ?>"></div>
                <div class="arfsubmitsettingpencil arfhelptip" title="<?php echo addslashes(__('Settings', 'ARForms')); ?>" id="field-setting-button-arfsubmit" onclick="arfshowfieldoptions('arfsubmit')" data-lower="false"></div>
            </div>
        </div>
    </div>
    <?php
