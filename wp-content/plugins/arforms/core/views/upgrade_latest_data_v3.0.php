...
$global_options->arfmainformloadjscss = 0;
$global_options->arf_load_js_css = array();
$global_options->arf_email_format = 'html';
...
if( file_exists( WP_PLUGIN_DIR.'/arformsignature/arformsignature.php' ) ){
	if( file_exists( WP_PLUGIN_DIR.'/arformsignature/core/arf_signature_field_data.json' )){
		...
		$field_data_obj['signature'] = array(
			'required' => 0,
			'required_indicator' => '*',
			'name' => addslashes(__('Signature','ARForms')),
			'blank' => addslashes(__('This field cannot be blank.', 'ARForms')),
			'description' => '',
			'classes' => 'arf_1',
...
if( file_exists( WP_PLUGIN_DIR.'/arformsdigitalproduct/arformsdigitalproduct.php' ) ){
	if( file_exists( WP_PLUGIN_DIR.'/arformsdigitalproduct/core/views/arf_download_field_data.json') ){
		...
		$field_data_obj['arf_product'] = array(
			'name' => addslashes(__('Product','ARForms')),
			'classes' => 'arf_1',
			'inner_class' => 'arf_1col',
			'attach' => 0,
			'arf_product_exp_time_val' => '24',
			'arf_download_show_link' => '',
			'arf_download_link_content' => addslashes(__('Please download your product by clicking below link','ARForms')).' [ARF_download_link product_id="0" desc="'.addslashes(__('Download','ARForms')).'" type="link"]',
			'type' => 'arf_product',
			'key' => '{arf_unique_key}'
		);
	}
...
if( !isset($field_data_obj['captcha']) ){
	$field_data_obj['captcha'] = array(
		"invalid"=> addslashes(__("The reCAPTCHA was not entered correctly","ARForms")),
        "name"=> "Untitled",
        "description"=> "",
