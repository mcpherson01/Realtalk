    ...
    if (is_array($arf_addons) && count($arf_addons) > 0) {
        ...
        foreach ($arf_addons as $arf_addon) {
            ...
            ?>
                ...
                <div class="add_more">
                    <a href="<?php echo $arf_addon['detail_url']; ?>" class="addon_readmore" target="_blank"><?php echo addslashes(__('Read More...', 'ARForms')); ?></a>
                </div>
...
<div id="error_message" class="arf_error_message">
    <div class="message_descripiton">
        <div id="arf_plugin_install_error" style="float: left; margin-right: 15px;" id=""><?php echo addslashes(__('File is not proper.', 'ARForms')); ?></div>
