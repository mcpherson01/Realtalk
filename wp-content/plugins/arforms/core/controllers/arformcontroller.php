...
<?php
    ...
    function arfformsavealloptions() {
        ...
        $form_css['arf_bg_position_x'] = (isset($_REQUEST['arf_bg_position_x']) && $_REQUEST['arf_bg_position_x'] != '') ? $_REQUEST['arf_bg_position_x'] : "left";
        $form_css['arf_bg_position_y'] = (isset($_REQUEST['arf_bg_position_y']) && $_REQUEST['arf_bg_position_y'] != '') ? $_REQUEST['arf_bg_position_y'] : "top";
	
        $form_css['arf_bg_position_input_x'] = (isset($_REQUEST['arf_bg_position_input_x']) && $_REQUEST['arf_bg_position_input_x'] != '') ? $_REQUEST['arf_bg_position_input_x'] : "";
        $form_css['arf_bg_position_input_y'] = (isset($_REQUEST['arf_bg_position_input_y']) && $_REQUEST['arf_bg_position_input_y'] != '') ? $_REQUEST['arf_bg_position_input_y'] : "";
    ...
    function arfverifypurchasecode() {
		global $arformcontroller, $arsettingcontroller;
		  ...
		  $checklic = $arformcontroller->checksoringcode('www.nulled.ch', '$info');
    ...
    function checksoringcode($code, $info) {
		global $arformcontroller; 
		  $setdata = $arformcontroller->setdata('www.nulled.ch', '$info');
		  return $setdata;
		exit;
