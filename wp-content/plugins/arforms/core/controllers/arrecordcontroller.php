...
class arrecordcontroller {
    ...
    function show_form($id = '', $key = '', $title = false, $description = false, $preview = false, $is_widget_or_modal = false) {
        ...
        if ((@$form->is_template or @ $form->status == 'draft') and ! ($preview)) {
            return addslashes(__('Please select a valid form', 'ARForms'));
    ...
    function process_entry($errors = '') {
        ...
        if (isset($_POST['using_ajax']) and strtolower(trim($_POST['using_ajax'])) == 'yes') {
            ...
            if (!$validate) {
                ...
                $message = '<div class="arf_form ar_main_div_{arf_form_id} arf_error_wrapper" id="arffrm_{arf_form_id}_container"><div class="frm_error_style" id="arf_message_error"><div class="msg-detail"><div class="arf_res_front_msg_desc">' . addslashes(__('Spam Detected', 'ARForms')) . '</div></div></div></div>';
    ...
    function menu() {
        ...
        add_submenu_page('ARForms', 'ARForms' . ' | ' . addslashes(__('Form Entries', 'ARForms')), addslashes(__('Form Entries', 'ARForms')), 'arfviewentries', 'ARForms-entries', array(&$this, 'route'));
    ...
    function admin_js() {
        ...
        if (isset($_GET) and isset($_GET['page']) and ( $_GET['page'] == 'ARForms-entries' or $_GET['page'] == 'ARForms-entry-templates' or $_GET['page'] == 'ARForms-import' or $_REQUEST['page'] == "ARForms" && ((isset($_REQUEST['arfaction']) && $_REQUEST['arfaction'] == 'edit') || (isset($_REQUEST['arfaction']) && $_REQUEST['arfaction'] == 'new') || (isset($_REQUEST['arfaction']) && $_REQUEST['arfaction']) == 'duplicate' || (isset($_REQUEST['arfaction']) && $_REQUEST['arfaction'] == 'update')))) {
            ...
            if ($_GET['page'] == 'ARForms-entries' or $_REQUEST['page'] == "ARForms" && ($_REQUEST['arfaction'] == 'edit' || $_REQUEST['arfaction'] == 'new' || $_REQUEST['arfaction'] == 'duplicate' || $_REQUEST['arfaction'] == 'update')) {
            ...
            (function($) {
                ...
                ?>
                    if (typeof (__ARFERR) != 'undefined') {
                        ...
                        var file_error = '<?php echo addslashes(__('Sorry, this file type is not permitted for security reasons.', 'ARForms')); ?>';
                    }
                                                    ...
                                                    setTimeout(function () {
                                                        ...
                                                        if (is_formreset == 1)
                                                        {
                                                            ...
                                                            jQuery(object).find('.original_normal').each(function () {
                                                                ...
                                                                jQuery('#file_name_' + field_key).text('<?php echo addslashes(__('No file selected', 'ARForms')); ?>');
                                                            });
                                                        }
    ...
    function create() {
        ...
        if (count($errors) > 0) {
            ...
            if (isset($_POST['arfpageorder' . $form->id])) {
                ...
                if ($record)
                    $message = addslashes(__('Entry is Successfully Created', 'ARForms'));
    ...
    function destroy() {
        ...
        if ($db_record->destroy($params['id']))
            $message = addslashes(__('Entry is Successfully Deleted', 'ARForms'));
        ...
        if ($params['form']) {
            ...
            foreach ($entry_ids as $entry_id) {
                ...
                if ($db_record->destroy($entry_id))
                    $message = addslashes(__('Entries were Successfully Destroyed', 'ARForms'));
            }
        }else {


            $errors = addslashes(__('No entries were specified', 'ARForms'));
        }
            ...
            if ($bulkaction == 'delete') {
                ...
                if ($form_id) {
                    ...
                    if ($form)
                        ...
                        $errors[] = addslashes(__('No form is found', 'ARForms'));
                }
    ...
    function ajax_destroy($form_id = false, $ajax = true, $echo = true) {
        ...
        if (!$entry_id) {
            ...
            $message = addslashes(__('There is an error deleting that entry', 'ARForms'));
            ...
            if ($ajax) {
                ...
                $message = addslashes(__('Your entry is successfully deleted', 'ARForms'));
    ...
    function send_email($entry_id, $form_id, $type) {
        ...
        if (current_user_can('arfviewforms') or current_user_can('arfeditforms')) {
            ...
            echo addslashes(__('No one! You do not have permission', 'ARForms'));
        }
    }
    ...
    function arfchangebulkentries() {
        ...
        if ($bulk_action == '-1') {
            echo json_encode(array('error' => true, 'message' => addslashes(__('Please select valid action.', 'ARForms'))));
            die();
        }

        if (empty($items)) {
            echo json_encode(array('error' => true, 'message' => addslashes(__('Please select one or more records', 'ARForms'))));
            die();
        }
            ...
            if (!current_user_can('arfdeleteentries')) {
                ...
                if (is_array($items)) {
                    ...
                    if ($del_res) {
                        ...
                        $message = addslashes(__('Entries deleted successfully.', 'ARForms'));
    ...
    function frm_change_entries($new_form_id = '', $new_start_date = '', $new_end_date = '', $bulk = '', $message = '', $errors = '') {
        ...
        <div class="arf_form_entry_select">
            <div class="arf_form_entry_select_sub">	
                <div>
                    <div class="arf_form_entry_left"><?php echo addslashes(__('Select form', 'ARForms')); ?>:</div>
                    <div style=" <?php echo $sel_frm_txt; ?>" ><div class="sltstandard" style="float:none;"><?php $arformhelper->forms_dropdown('arfredirecttolist', $new_form_id, addslashes(__('Select Form', 'ARForms')), false, ""); ?></div></div>
                </div>
        <?php
        if (is_rtl()) {
        ...
        ?>
                <div style=" <?php echo $sel_frm_div ?>">
                    <div class="arf_form_entry_left"><div><?php echo addslashes(__('Select date From', 'ARForms')); ?>:</div><div class="arf_form_entry_left_sub">(<?php echo addslashes(__('optional', 'ARForms')); ?>)</div></div>
                    <div style=" <?php echo $sel_frm_date_wrap; ?>">
                        <div style=" <?php echo $sel_frm_sel_date; ?>"><input type="text" class="txtmodal1" id="datepicker_from" value="<?php echo $show_new_start_date; ?>" name="datepicker_from" style="vertical-align:middle; width:130px;" /></div> <div class="arfentrytitle"><?php echo addslashes(__('To', 'ARForms')); ?>:</div>&nbsp;&nbsp;<div style="float:left;"><input type="text" class="txtmodal1" id="datepicker_to" name="datepicker_to"  value="<?php echo $show_new_end_date; ?>" style="vertical-align:middle;  width:130px;"/></div>

                    </div>

                    <div style=" <?php echo $sel_frm_button; ?>">
                        <div class="arf_form_entry_left">&nbsp;</div>
                        <div style="float:left;text-align:left;"><button type="button" class="rounded_button btn_green" onclick="change_frm_entries();"><?php echo addslashes(__('Submit', 'ARForms')); ?></button></div>
                    </div>        
        ...
        foreach ($actions as $name => $title) {
            ...
            ?>
                ...
                <input type="submit" id="doaction<?php echo $two; ?>" class="rounded_button btn_blue" value="<?php echo addslashes(__('Apply', 'ARForms')) ?>" style='margin-top:-2px;' />
            </div>
        ...
        if (count($form_cols) > 0) {
            foreach ($form_cols as $col) {
                ...
                ?>
                <th><?php echo addslashes(__('Entry Key', 'ARForms')); ?></th>
                ...
                <th class="arf_col_action"><?php echo addslashes(__('Action', 'ARForms')); ?></th>
                </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    if (count($items) > 0) {
                        ...
                        foreach ($items as $key => $item) {
                            ...
                            <tr>
                                ...
                                <?php $http_referrer = unserialize($item->description); ?>
                                ...
                                <td class="arf_col_action">			
                                    <div class="arf-row-actions">  
                                        ...
                                        <?php
                                        if (is_rtl()) {
                                            echo "<a href='javascript:void(0);' onclick='open_entry_thickbox({$item->id});'><img src='" . ARFIMAGESURL . "/view_icon23_rtl.png' title='" . addslashes(__("View Entry", "ARForms")) . "' class='arfhelptip' onmouseover=\"this.src='" . ARFIMAGESURL . "/view_icon23_hover_rtl.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/view_icon23_rtl.png';\" /></a>";
                                        } else {
                                            echo "<a href='javascript:void(0);' onclick='open_entry_thickbox({$item->id});'><img src='" . ARFIMAGESURL . "/view_icon23.png' title='" . addslashes(__("View Entry", "ARForms")) . "' class='arfhelptip' onmouseover=\"this.src='" . ARFIMAGESURL . "/view_icon23_hover.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/view_icon23.png';\" /></a>";
                                        }
                                        ...
                                        if (is_rtl()) {
                                            echo "<img src='" . ARFIMAGESURL . "/delete_icon223_rtl.png' class='arfhelptip' title=" . addslashes(__("Delete", "ARForms")) . " onmouseover=\"this.src='" . ARFIMAGESURL . "/delete_icon223_hover_rtl.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/delete_icon223_rtl.png';\" onclick=\"ChangeID({$id}); arfchangedeletemodalwidth('arfdeletemodabox');\" data-toggle='arfmodal' href='#delete_form_message' style='cursor:pointer' /></a>";
                                        } else {
                                            echo "<img src='" . ARFIMAGESURL . "/delete_icon223.png' class='arfhelptip' title=" .addslashes(__("Delete", "ARForms")) . " onmouseover=\"this.src='" . ARFIMAGESURL . "/delete_icon223_hover.png';\" onmouseout=\"this.src='" . ARFIMAGESURL . "/delete_icon223.png';\" onclick=\"ChangeID({$id}); arfchangedeletemodalwidth('arfdeletemodabox');\" data-toggle='arfmodal' href='#delete_form_message' style='cursor:pointer' /></a>";
                                        }
                        ...
                        <div class='arf_popup_container_header'>" . __('View entry', 'ARForms') . "
    ...
    function get_entries_list($id = '') {
        ...
        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left"><strong>' . addslashes(__('Created at', 'ARForms')) . ':</strong></td><td class="arfviewentry_right">' . $armainhelper->get_formatted_time($entry->created_date, $date_format, $time_format);
        ...
        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left"><strong>' . __('Page url', 'ARForms') . ':</strong></td><td class="arfviewentry_right">' . $data['page_url'];
        $var .= '</td></tr>';

        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left"><strong>' . addslashes(__('Referrer url', 'ARForms')) . ':</strong></td><td class="arfviewentry_right">' . $data['http_referrer'];
        $var .= '</td></tr>';
    ...
    function get_entries_list_edit($id = '', $arffieldorder = array()) {
        ...
        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left arfwidth25">' . addslashes(__('Created at', 'ARForms')) . ':</td><td class="arfviewentry_right"><span class="arf_not_editable_values_container">' . $armainhelper->get_formatted_time($entry->created_date, $date_format, $time_format) .'</span>';
        if ($entry->user_id) {
        ...
        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left arfwidth25">' . __('Page url', 'ARForms') . ':</td><td class="arfviewentry_right"><span class="arf_not_editable_values_container">' . $data['page_url'] . '</span>';
        $var .= '</td></tr>';

        $var .= '<tr class="arfviewentry_row"><td class="arfviewentry_left arfwidth25">' . addslashes(__('Referrer url', 'ARForms')) . ':</td><td class="arfviewentry_right"><span class="arf_not_editable_values_container">' . $data['http_referrer'] . '</span>';
        $var .= '</td></tr>';
    ...
    function arfentryactionfunc() {
        ...
        if ($_REQUEST['act'] == 'delete' and $_REQUEST['id'] != '') {
            ...
            if ($del_res)
                $message = addslashes(__('Entry deleted successfully', 'ARForms'));
    ...
    function arf_edit_entry_values() {
        ...
        $arf_return = array('status' => 'error', 'message' => addslashes(__('Record could not be updated','ARForms')));
        ...
        if (!empty($entry_id) && count($arfupdatedfields) > 0) {
            ...
            if(count($arfdraw_cols) > 0){
                $arf_return = array('status' => 'success', 'message' => addslashes(__('Record is updated successfully.','ARForms')), 'updatecols' => $arfdraw_cols, 'edit_select_options' => $edit_select_options);
            }
    ...
    function arf_delete_single_entry_function(){
        ...
        if( $entry_id < 1 ){
            echo json_encode(array('error'=>true,'message'=>addslashes(__('Please select one or more record.','ARForms'))));
            die();
        }
        ...
        if( $del_res ){
            ...
            echo json_encode(array('error' => false, 'message' => addslashes(__('Record is deleted successfully.','ARForms')), 'arftotrec' => $total_records));

        } else {
            echo json_encode(array('error' => true, 'message' => addslashes(__('Record could not be deleted','ARForms'))));
        }
    ...
    function ajax_check_spam_filter() {
        ...
        if (!$validate) {
            $response['error'] = true;
            $response['message'] = addslashes(__('Spam Detected', 'ARForms'));
