	...
	vc_map(array(
		...
		'params' => array(
			...
			array(
				...
				'param_name' => 'order',
				'value' => array(
					__('Default', ELFSIGHT_YOTTIE_TEXTDOMAIN) => '',
			...
			array(
				...
				'param_name' => 'lang',
				'value' => array(
					__('Čeština', ELFSIGHT_YOTTIE_TEXTDOMAIN) => 'cs',
					...
					__('Slovenčina', ELFSIGHT_YOTTIE_TEXTDOMAIN) => 'sk',
				...
				'std' => esc_attr($lang),
				'description' => __('Choose one of 18 available languages of plugin\'s UI.', ELFSIGHT_YOTTIE_TEXTDOMAIN),
				'group' => 'Language'
			),
			...
			array(
				...
				'value' => array(
					__('Visible', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $header_visible ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Visible', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $groups_visible ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Arrows control', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_arrows_control ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Scroll control', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_scroll_control ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Drag control', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_drag_control ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Free mode', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_free_mode ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Scrollbar', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_scrollbar ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					__('Pause on hover', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $content_auto_pause_on_hover ? 'yes' : 'no'
				),
				'std' => 'yes',
			...
			array(
				...
				'value' => array(
					...
					__('Share', ELFSIGHT_YOTTIE_TEXTDOMAIN) => 'share',
					__('Date', ELFSIGHT_YOTTIE_TEXTDOMAIN) => 'date',
					__('Description', ELFSIGHT_YOTTIE_TEXTDOMAIN) => 'description',
			...
			array(
				...
				'value' => array(
					__('Autoplay', ELFSIGHT_YOTTIE_TEXTDOMAIN) => $popup_autoplay ? 'yes' : 'no'
				),
				'std' => 'yes',
