<div class="yottie-demo">
    <form class="yottie-demo-form">
        <input type="hidden" name="key" value="<?php echo $preferences_youtube_api_key; ?>">
                ...
                <div class="yottie-demo-accordion-item-content">
                    <div class="yottie-demo-lang yottie-demo-field">
                        ...
                        <select class="yottie-demo-select-language yottie-demo-select" name="lang">
                            <option value="cs"><?php _e('Čeština', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></option>
                            ...
                            <option value="sk"><?php _e('Slovenčina', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></option>
                        ...
                        <span class="yottie-demo-tooltip">
                            ...
                            <span class="yottie-demo-tooltip-content">
                                <span class="yottie-demo-tooltip-content-inner">
                                    <?php _e('Choose one of 18 languages<br> of Plugin\' UI', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?>
                                </span>
                            </span>
                        </span>
                    </div>
                ...
                <div class="yottie-demo-accordion-item-content">
                    ...
                    <div class="yottie-demo-field-group">
                        ...
                        <div class="yottie-demo-field-col-1-2">
                            ...
                            <div class="yottie-demo-field">
                                <label>
                                    <input class="yottie-demo-checkbox" type="checkbox" name="popupInfo[]" value="share">
                                    <span class="yottie-demo-checkbox-label"><?php _e('Share', ELFSIGHT_YOTTIE_TEXTDOMAIN); ?></span>
                                </label>
                            </div>
