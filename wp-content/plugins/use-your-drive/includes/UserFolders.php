...
class UserFolders {
    ...
    public function remove_user_folder($user_id) {
        ...
        foreach ($useyourdrivelists as $list) {
            ...
            foreach ($api_files as $api_file) {
                $batch->add($this->get_app()->get_drive()->files->update($api_file->getId(), $updateentry, array("supportsAllDrives" => true, "userIp" => $this->get_processor()->get_user_ip())));
            }
        }
    ...
    public function get_guest_user_name() {
        ...
        $current_user->user_role = __('Anonymous user', 'useyourdrive');
