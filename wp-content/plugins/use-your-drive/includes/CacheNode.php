...
class CacheNode {
    ...
    public function get_linked_users() {
        ...
        $manually_linked_users = (get_users(array('meta_query' => $meta_query)));
    ...
    public function get_cache_name() {
        $prefix = (in_array($this->_id, array('drive', 'sharedfolder', 'team-drives'))) ? $this->get_processor()->get_current_account()->get_id() : '';
