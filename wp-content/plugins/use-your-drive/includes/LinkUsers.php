...
class User_List_Table extends \WP_List_Table {
    ...
    private function table_data($users) {
        ...
        $data[] = array(
            ...
            'username' => __('Anonymous user', 'useyourdrive'),
            ...
            case 'private_folder':
                ...
                if (isset($linked_data['foldertext'])) {
                    ...
                    if (!empty($linked_account)) {
                        ...
                        return '<code>' . sprintf(__('Account with ID: %s not found', 'useyourdrive'), $linked_data['accountid']) . '.</code> <p>' . $linked_data['foldertext'] . '</p>';
                    }
                }
