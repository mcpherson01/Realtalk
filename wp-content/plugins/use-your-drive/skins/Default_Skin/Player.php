...
class Default_Skin extends \TheLion\UseyourDrive\MediaplayerSkin {
    ...
    public function load_scripts() {
        ...
        wp_register_script('Default_Skin.Library', $this->get_url() . '/js/mediaelement-and-player.js', false, USEYOURDRIVE_VERSION);
        wp_register_script('UseyourDrive.Default_Skin.Player', $this->get_url() . '/js/Player.js', array('Default_Skin.Polyfill', 'Default_Skin.Library'), USEYOURDRIVE_VERSION, true);

        wp_enqueue_script('UseyourDrive.Default_Skin.Player');

        $localize_library = array(
            ...
            'strings' => array(
                ...
                'mejs.purchase' => __('Purchase', 'useyourdrive'),
    ...
    public function load_styles() {
        wp_register_style('UseyourDrive.Default_Skin.Player.CSS', $this->get_url() . '/css/style.css', false, USEYOURDRIVE_VERSION);
