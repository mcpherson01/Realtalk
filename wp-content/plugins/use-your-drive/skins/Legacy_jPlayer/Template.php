...
$extensions = ($this->get_processor()->get_shortcode_option('extensions') !== null) ? $this->get_processor()->get_shortcode_option('extensions') : array();
...
if (empty($extensions)) {
    $extensions = ($this->get_processor()->get_shortcode_option('mode') === 'audio') ? array('mp3') : array('m4v');
}
...
<div id="jp_container_<?php echo $this->get_processor()->get_listtoken(); ?>" class="jp_container jp-video <?php echo $classes; ?>" style="width:<?php echo $max_width; ?>;max-width:<?php echo $max_width; ?>;" data-autoplay="<?php echo $autoplay; ?>" data-extensions="<?php echo $extensions; ?>">
  ...
  <div class="jp-playlist <?php echo ($show_playlistonstart === '1') ? '' : 'hideonstart'; ?>" style="display:none;">
    <ul data-folder>
