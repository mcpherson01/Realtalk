  ...
  <div class="useyourdrive admin-settings">
    ...
    <div class="wrap">
      <div class="useyourdrive-header">
        ...
        <div class="useyourdrive-form-buttons"> <div id="clear_statistics" class="simple-button default clear_statistics" name="clear_statistics"><?php _e("Clear all Statistics", 'useyourdrive'); ?>&nbsp;<div class='uyd-spinner'></div></div></div>
