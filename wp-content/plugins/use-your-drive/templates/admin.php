      ...
      <div id="" class="useyourdrive-panel useyourdrive-panel-left">      
        ...
        <ul class="useyourdrive-nav-tabs">
          ...
          if ($this->is_activated()) {
              ...
              <li id="settings_integrations_tab" data-tab="settings_integrations" ><a><?php _e('Integrations', 'useyourdrive'); ?></a></li>
      ...
      <div class="useyourdrive-panel useyourdrive-panel-right">
        ...
        <div id="settings_general" class="useyourdrive-tab-panel current">
          ...
          <?php if ($this->is_activated()) { ?>
              ...
              <div class="useyourdrive-accounts-list">
                <?php
                if ($this->get_processor()->is_network_authorized() === false || ($this->get_processor()->is_network_authorized() && is_network_admin() === true)) {
                    $app = $this->get_app();
                    ...
                    <div class='account account-new'>
                      ...
                      <div class='account-info-container'>
                        <div class='account-info'>
                          <span class="account-info-space"><?php echo sprintf(__("The authorization is managed by the Network Admin via the <a href='%s'>Network Settings Page</a> of the plugin", 'useyourdrive'), network_admin_url('admin.php?page=UseyourDrive_network_settings')); ?>.</span>
                        </div>
                      </div>
                    </div>   
                    <?php
        ...
        <div id="settings_layout"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            ...
            <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Media Player', 'useyourdrive'); ?></div>
            <div>
        ...
        <div id="settings_userfolders"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Global settings automatically linked Private Folders', 'useyourdrive'); ?> </div>
            <div>

              <div class="uyd-warning">
                <i><strong>NOTICE</strong>: <?php _e("The following settings are only used for all shortcodes with automatically linked Private Folders", 'useyourdrive'); ?>. </i>
              </div>
            ...
            if (!empty($main_account)) {
                ?>
                <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Private Folders in WP Admin Dashboard', 'useyourdrive'); ?> </div>
                <div>

                  <div class="uyd-warning">
                    <i><strong>NOTICE</strong>: <?php _e("This setting only restrict access of the File Browsers in the Admin Dashboard (e.g. the ones in the Shortcode Builder and the File Browser menu). To enable Private Folders for your own Shortcodes, use the Shortcode Builder", 'useyourdrive'); ?>. </i>
                  </div>

                  <div class="useyourdrive-option-description"><?php _e("Enable Private Folders in the Shortcode Builder and Back-End File Browser", 'useyourdrive'); ?>.</div>
        ...
        <div id="settings_advanced"  class="useyourdrive-tab-panel">
          ...
          <?php if ($network_wide_authorization === false) { ?>
          ...
          <div class="useyourdrive-option-title"><?php _e('Manage Permission', 'useyourdrive'); ?>
            ...
            <div class="useyourdrive-option-description"><?php _e('If you want to manage the sharing permissions by yourself or if you want users to login to Google, disable the -Manage Permissions- function.', 'useyourdrive'); ?>.</div>
          </div>
          ...
          <div class="useyourdrive-option-title"><?php _e('Enable Font Awesome Library v4 compatibility', 'useyourdrive'); ?>
            <div class="useyourdrive-onoffswitch">
              <input type='hidden' value='No' name='use_your_drive_settings[fontawesomev4_shim]'/>
              <input type="checkbox" name="use_your_drive_settings[fontawesomev4_shim]" id="fontawesomev4_shim" class="useyourdrive-onoffswitch-checkbox" <?php echo ($this->settings['fontawesomev4_shim'] === "Yes") ? 'checked="checked"' : ''; ?> />
              <label class="useyourdrive-onoffswitch-label" for="fontawesomev4_shim"></label>
            </div>
            <div class="useyourdrive-option-description"><?php _e('If your theme is loading the old Font Awesome icon library (v4), it can cause conflict with the (v5) icons of this plugin. If you are having trouble with the icons, please enable this setting for backwards compatibility', 'useyourdrive'); ?>. <?php _e('To disable the Font Awesome library of this plugin completely, add this to your wp-config.php file', 'useyourdrive'); ?>: <code>define('WPCP_DISABLE_FONTAWESOME', true);</code></div>
          </div>            
          ...
          <div class="useyourdrive-option-title"><?php _e('Synchronize via WP-Cron', 'useyourdrive'); ?>
            <div class="useyourdrive-onoffswitch">
          ...
          <div class="useyourdrive-suboptions option bitly" <?php echo ($this->settings['shortlinks'] !== "Bit.ly" ? "style='display:none;'" : ''); ?>>
            <div class="useyourdrive-option-description"><a href="https://bitly.com/a/sign_up" target="_blank"><?php _e('Sign up for Bitly', 'useyourdrive'); ?></a> and <a href="http://bitly.com/a/your_api_key" target="_blank">generate an API key</a></div>
        ...
        <div id="settings_integrations"  class="useyourdrive-tab-panel">
          <div class="useyourdrive-tab-panel-header"><?php _e('Integrations', 'useyourdrive'); ?></div>

          <div class="useyourdrive-accordion">

            <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('ReCaptcha V3', 'useyourdrive'); ?>         </div>
            <div>

              <div class="useyourdrive-option-description"><?php _e('reCAPTCHA protects you against spam and other types of automated abuse. With this reCAPTCHA (V3) integration module, you can block abusive downloads of your files by bots. Create your own credentials via the link below.', 'useyourdrive'); ?> <br/><br/><a href="https://www.google.com/recaptcha/admin" target="_blank">Manage your reCAPTCHA API keys</a></div>

              <div class="useyourdrive-option-title"><?php _e('Site Key', 'useyourdrive'); ?></div>
              ...
              <div class="useyourdrive-option-title"><?php _e('Secret Key', 'useyourdrive'); ?></div>
          ...
          <div class="useyourdrive-accordion">
            ...
            <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Video Advertisements (IMA/VAST)', 'useyourdrive'); ?> </div>
            <div>
              <div class="useyourdrive-option-description"><?php _e('The mediaplayer of the plugin supports VAST XML advertisments to offer monetization options for your videos. You can enable advertisments for the complete site and per Media Player shortcode. Currently, this plugin only supports Linear elements with MP4', 'useyourdrive'); ?>.</div>

              <div class="useyourdrive-option-title"><?php echo 'VAST XML Tag Url'; ?></div>
              <input class="useyourdrive-option-input-large" type="text" name="use_your_drive_settings[mediaplayer_ads_tagurl]" id="mediaplayer_ads_tagurl" value="<?php echo esc_attr($this->settings['mediaplayer_ads_tagurl']); ?>" placeholder="<?php echo __('Leave empty to disable Ads', 'useyourdrive'); ?>" />
              ...
              <div class="useyourdrive-option-title"><?php _e('Enable Skip Button', 'useyourdrive'); ?>
                <div class="useyourdrive-onoffswitch">
                  ...
                  <input type="checkbox" name="use_your_drive_settings[mediaplayer_ads_skipable]" id="mediaplayer_ads_skipable" class="useyourdrive-onoffswitch-checkbox" <?php echo (($this->settings['mediaplayer_ads_skipable'] === 'Yes') ? 'checked="checked"' : ''); ?> data-div-toggle="ads_skipable"/>
                  <label class="useyourdrive-onoffswitch-label" for="mediaplayer_ads_skipable"></label>
                </div>
              </div>

              <div class="useyourdrive-suboptions ads_skipable <?php echo (($this->settings['mediaplayer_ads_skipable'] === 'Yes') ? '' : 'hidden') ?> ">
        ...
        <div id="settings_notifications"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            ...
            <div>
              ...
              <div class="useyourdrive-option-title"><?php _e('Template download', 'useyourdrive'); ?> (HTML):</div>
              <?php
              ob_start();
              ...
              <div class="useyourdrive-option-description"><?php _e('Available placeholders', 'useyourdrive'); ?>: 
                <code>%site_name%</code>, 
            ...
            <div>
              ...
              <div class="useyourdrive-option-title"><?php _e('Template upload', 'useyourdrive'); ?> (HTML):</div>
              <?php
              ob_start();
            ...
            <div>
              ...
              <div class="useyourdrive-option-title"><?php _e('Template deletion', 'useyourdrive'); ?> (HTML):</div>
            ...
            <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Template %filelist% placeholder', 'useyourdrive'); ?>         </div>
            <div>
              <div class="useyourdrive-option-description"><?php _e('Template for File item in File List in the download/upload/delete notification template', 'useyourdrive'); ?> (HTML).</div>
              <?php
              ob_start();
          ...
          <div id="reset_notifications" type="button" class="simple-button blue"><?php _e('Reset to default notifications', 'useyourdrive'); ?>&nbsp;<div class="uyd-spinner"></div></div>
        ...
        <div id="settings_stats"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-option-title"><?php _e('Log Events', 'useyourdrive'); ?>
            <div class="useyourdrive-onoffswitch">
              ...
              <input type="checkbox" name="use_your_drive_settings[log_events]" id="log_events" class="useyourdrive-onoffswitch-checkbox" <?php echo ($this->settings['log_events'] === "Yes") ? 'checked="checked"' : ''; ?> data-div-toggle="events_options"/>
          ...
          <div class="useyourdrive-suboptions events_options <?php echo (($this->settings['log_events'] === 'Yes') ? '' : 'hidden') ?> ">
            <div class="useyourdrive-option-title"><?php _e('Summary Email', 'useyourdrive'); ?>
              <div class="useyourdrive-onoffswitch">
                <input type='hidden' value='No' name='use_your_drive_settings[event_summary]'/>
                <input type="checkbox" name="use_your_drive_settings[event_summary]" id="event_summary" class="useyourdrive-onoffswitch-checkbox" <?php echo (($this->settings['event_summary'] === 'Yes') ? 'checked="checked"' : ''); ?> data-div-toggle="event_summary"/>
                <label class="useyourdrive-onoffswitch-label" for="event_summary"></label>
              </div>
            </div>
            <div class="useyourdrive-option-description"><?php _e("Email a summary of all the events that are logged with the plugin", "useyourdrive"); ?>.</div>

            <div class="event_summary <?php echo (($this->settings['event_summary'] === 'Yes') ? '' : 'hidden') ?> ">

              <div class="useyourdrive-option-title"><?php _e('Interval', 'useyourdrive'); ?></div>
              <div class="useyourdrive-option-description"><?php _e('Please select the interval the summary needs to be send', 'useyourdrive'); ?>.</div>
              <select type="text" name="use_your_drive_settings[event_summary_period]" id="shortlinks">
                <option value="daily"  <?php echo ($this->settings['event_summary_period'] === "daily" ? "selected='selected'" : ''); ?>><?php _e('Every day', 'useyourdrive'); ?></option>
                <option value="weekly"  <?php echo ($this->settings['event_summary_period'] === "weekly" ? "selected='selected'" : ''); ?>><?php _e('Weekly', 'useyourdrive'); ?></option>
                <option value="monthly"  <?php echo ($this->settings['event_summary_period'] === "monthly" ? "selected='selected'" : ''); ?>><?php _e('Monthly', 'useyourdrive'); ?></option>
              </select>   

              <div class="useyourdrive-option-title"><?php _e('Recipients', 'useyourdrive'); ?></div>
              <div class="useyourdrive-option-description"><?php _e('Send the summary to the following email address(es)', 'useyourdrive'); ?>:</div>
          ...
          <div class="useyourdrive-option-description"><?php _e("Would you like to see some statistics about your files? Use-your-Drive can send all download/upload events to Google Analytics", "useyourdrive"); ?>. <?php echo sprintf(__("If you enable this feature, please make sure you already added your %s Google Analytics web tracking %s code to your site.", "useyourdrive"), "<a href='https://support.google.com/analytics/answer/1008080' target='_blank'>", "</a>"); ?>.</div>
        </div>
        <!-- End Statistics Tab -->
