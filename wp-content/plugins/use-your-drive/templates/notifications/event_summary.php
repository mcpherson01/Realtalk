                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                    <?php
                                        echo sprintf(__('This is the latest summary of all the activites that are logged since %s', 'useyourdrive'), "<em>" . date_i18n('l j F ' . get_option('time_format'), date_format($since, 'U')) . "</em>");
                                    ?>.
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;table-layout:auto;width:100%;">
                                    <?php
                                        if ($topdownloads['recordsFiltered'] === 0) {
                                    ?>
                                    <tr>
                                      <td style="width:20px;padding-right:10px;padding-top: 5px;padding-left: 5px;">
                                        <em>- 
                                          <?php _e('No downloads found in this period', 'useyourdrive'); ?> -
                                        </em>
                                      </td>
                                    </tr>
                                    <?php
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;table-layout:auto;width:100%;">
                                    <?php
                                        if ($all_events['recordsFiltered'] === 0) {
                                    ?>
                                    <tr>
                                      <td style="width:20px;padding-right:10px;padding-top: 5px;padding-left: 5px;">
                                        <em>- 
                                          <?php _e('No activities found in this period', 'useyourdrive'); ?> -
                                        </em>
                                      </td>
                                    </tr>
                                    <?php
                                        ...
                                        <a href="<?php echo get_admin_url(null, 'admin.php?page=UseyourDrive_settings_dashboard'); ?>" style="background:<?php echo $colors['accent']; ?>;color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                                          <?php
                                            ...
                                            if ($total - $max_events > 0) {
                                                echo sprintf(__('View more activites (%s left)', 'useyourdrive'), ($total - $max_events));
                                            } else {
                                                _e('View all activites', 'useyourdrive');
                                            }
                                          ?>
                                        </a>
                                      </td>
