				...
				<table width="640" cellspacing="0" cellpadding="0" border="0" style="margin-top:0;margin-bottom:0;margin-right:10px;margin-left:10px">
					...
					<tr style="background-color:#ffffff;border-collapse:collapse;">
						<td style="font-size:13px;line-height:18px;color:#444444;padding-left:20px;padding-right:20px;">
							<p style="word-break:break-all;"><strong><?php _e('URL','SwiftSecurity');?>:</strong> <?php echo htmlentities($uri);?></p>
							
							<p style="word-break:break-all;"><strong><?php _e('COOKIES','SwiftSecurity');?>:</strong> <?php echo htmlentities($cookies);?></p>
							
							<p style="word-break:break-all;"><strong><?php _e('IP address','SwiftSecurity');?>:</strong> <?php echo htmlentities($ip);?></p>
							
							<p style="word-break:break-all;"><strong><?php _e('Host','SwiftSecurity');?>:</strong> <?php echo htmlentities($host);?></p>
							
							<p style="word-break:break-all;"><strong><?php _e('Useragent','SwiftSecurity');?>:</strong> <?php echo htmlentities($useragent);?></p>
