<?php
class FES_product_version_Field extends FES_Field {
	...
	public $characteristics = array(
		...
		'default'     => '',
		'size'        => '',
		'help'        => 'Add Product Version Number',
		'placeholder' => '',
	);

	public function set_title() {
		$title = _x( 'Product Version', 'FES Field title translation', 'mayosis' );
