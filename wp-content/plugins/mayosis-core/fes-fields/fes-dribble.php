<?php
class FES_dribble_profile_Field extends FES_Field {
    ...
    public $supports = array(
        ...
        'template'   => 'dribble_profile',
        'title'       => 'dribble_profile',
        'phoenix'    => true,
    );
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Dribble Profile URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Dribble', 'FES Field title translation', 'mayosis' );
