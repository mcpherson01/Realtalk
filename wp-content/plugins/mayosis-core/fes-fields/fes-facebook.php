<?php
class FES_facebook_profile_Field extends FES_Field {
    ...
    public $supports = array(
        ...
        'template'   => 'facebook_profile',
        'title'       => 'facebook_profile',
        'phoenix'    => true,
    );
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Facebook Profile URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Facebook', 'FES Field title translation', 'mayosis' );
