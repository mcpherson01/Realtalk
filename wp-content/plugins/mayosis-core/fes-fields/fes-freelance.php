<?php
class FES_fes_author_available_Field extends FES_Field {
    ...
    public $supports = array(
        ...
        'template'   => 'fes_author_available',
        'title'       => 'fes_author_available',
        'phoenix'    => true,
    );
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => '(i.e Available for Hire)',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Freealnce Availablity', 'FES Field title translation', 'mayosis' );
    ...
    public function validate( $values = array(), $save_id = -2, $user_id = -2 ) {
        ...
        if ( !empty( $values[ $name ] ) ) {
            ...
            if ( $this->required() ) {
                $return_value = __( 'Please fill out this field.', 'mayosis' );
            }
        }
