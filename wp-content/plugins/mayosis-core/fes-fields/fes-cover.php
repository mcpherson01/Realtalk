<?php
class FES_fes_cover_photo_Field extends FES_Field {
    ...
    public $supports = array(
        ...
        'template'   => 'fes_cover_photo',
        'title'       => 'fes_cover_photo',
        'phoenix'    => true,
    );
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Cover Photo External URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Cover Photo Url', 'FES Field title translation', 'mayosis' );
