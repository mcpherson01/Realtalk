<?php
class FES_twitter_profile_Field extends FES_Field {
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Twitter Profile URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Twitter', 'FES Field title translation', 'mayosis' );
