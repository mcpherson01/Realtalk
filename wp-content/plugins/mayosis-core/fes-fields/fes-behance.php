<?php
class FES_behance_profile_Field extends FES_Field {
    ...
    public $supports = array(
        ...
        'template'   => 'behance_profile',
        'title'       => 'behance_profile',
        'phoenix'    => true,
    );
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Behance Profile URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Behance', 'FES Field title translation', 'mayosis' );
