<?php
class FES_compatible_with_Field extends FES_Field {
	...
	public $supports = array(
		...
		'template'   => 'compatible_with',
		'title'       => 'compatible_with',
		'phoenix'    => true,
	);
	...
	public $characteristics = array(
		...
		'default'     => '',
		'size'        => '',
		'help'        => 'Add Compatible Files',
		'placeholder' => '',
	);

	public function set_title() {
		$title = _x( 'Compatible File', 'FES Field title translation', 'mayosis' );
