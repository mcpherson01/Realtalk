...
class LicenseBoxAPI {
  ...
  { 
    $this->product_id = '98C7A3B6';
    $this->api_url = 'https://teconce.app/';
    $this->current_version = '2.6.2';
    $this->current_path = realpath(__DIR__);
    $this->root_path = realpath($this->current_path.'/../../../../../themes');
    $this->verify_type = 'envato';
    $this->api_key = 'D3971F326CAB44431BF8';
  ...
  public function verify_license($time_based_check = false, $license = false, $client = false){
    ...
    $today = date('d-m-Y');
    if(empty($_SESSION["55f48bd26e"])){
      $_SESSION["55f48bd26e"] = '0000-00-00';
    }
    if($type==1){
    if($today>=$_SESSION["55f48bd26e"]){
