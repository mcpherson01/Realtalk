    ...
    public function admin_notice() {
        ...
        if ( ! $this->is_local_server() ) {
            ...
            if ( empty( $this->notice ) ) {
                $notice = sprintf( __( 'Want to help make <strong>Mayosis Theme</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.', 'textdomain' ), $this->name );
            } else {
                $notice = $this->notice;
            }
        ...
        <div class="wd-dr-modal" id="<?php echo $this->slug; ?>-wd-dr-modal">
            <div class="wd-dr-modal-wrap">
                <div class="wd-dr-modal-header">
                    <h3><?php _e( 'Want to disable Mayosis core?', 'domain' ); ?></h3>
                </div>

                <div class="wd-dr-modal-body">
                    <ul class="reasons">
                        This is the core plugin of Mayosis theme.If you want use the theme don't disable it.
                    </ul>
                </div>
