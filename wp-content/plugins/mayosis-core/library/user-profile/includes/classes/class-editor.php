...
class EDD_User_Profiles_Editor {
    ...
    public function avatar_field() {
        ...
        <fieldset>
            ...
            <div class="edd_profile_custom_avatar">
          ...
          <?php echo get_avatar( $id_or_email, $size, $default, $alt, $args ); ?> 
                    ...
                    <button type="button" id="edd_avatar_button" class="edd-avatar-button"><?php _e( 'Upload Avatar', 'edd-user-profiles' ); ?></button>
                </div>
               
                <div class="edd-avatar-preview-wrap <?php echo ((!$avatar) ? 'edd-user-profiles-hide' : '');?>">
                    <a href="#" id="edd_avatar_remove_button" class="edd-avatar-remove-button"><i class="zil zi-cross-ii-alt"></i></a>
                    <img src="<?php echo esc_url( $avatar ); ?>" alt="" id="edd_avatar_preview" style="width: 90px !important; height: 90px !important;">
                </div>
                </div>
            </div>
        </fieldset>
