...
final class PluginActivation {
	...
	public function remote_validation( $purchase_code ) {
		...
		$url .= 'plugin=deblocker&'; // Plugin Name.
		$url .= 'domain=' . parse_url( site_url(), PHP_URL_HOST ) . '&'; // Domain Name.
		$url .= 'version=2.0.2&'; // Plugin version.
	...
	public function add_settings() {
		...
		/** Activation Tab. */
		register_setting( 'DeBlockerActivationOptionsGroup', 'envato_purchase_code_' . EnvatoItem::get_instance()->get_id() );
		add_settings_section( 'mdp_deblocker_settings_page_activation_section', '', null, 'DeBlockerActivationOptionsGroup' );
	...
	public function render_pid() {
        ...
        <div class="mdp-activation">
            ...
            <div class="mdp-activation-form">
                ...
                <h3><?php esc_html_e( 'Plugin Activation', 'deblocker' ); ?></h3>

                <?php
                /** Render input. */
                UI::get_instance()->render_input(
                    $purchase_code,
                    esc_html__( 'CodeCanyon purchase code', 'deblocker'),
        ...
        <div class="mdc-accordion" data-mdc-accordion="showfirst: true">
            ...
            <div class="mdc-accordion-content">
                <p><?php esc_html_e( 'The purchase code is a unique combination of characters that confirms that you bought the plugin. You can find your purchase code in ', 'deblocker' ); ?>
                    <a href="https://1.envato.market/cc-downloads" target="_blank"><?php esc_html_e( 'your account', 'deblocker' );?></a>
			        <?php esc_html_e( ' on the CodeCanyon. Learn more about ', 'deblocker' ); ?>
            ...
            <div class="mdc-accordion-content">
                <p>
                    ...
                    <a href="https://1.envato.market/KYbje" target="_blank"><?php esc_html_e( 'Envato License', 'deblocker' );?></a>
	                <?php esc_html_e( ' terms. ', 'deblocker' ); ?>
                </p>
            </div>
            ...
            <div class="mdc-accordion-content">
                <p>
                    ...
                    <a href="https://help.market.envato.com/hc/en-us/articles/204451834-My-Purchase-Code-is-Not-Working" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'deblocker' );?></a>
	                <?php esc_html_e( ' .', 'deblocker');?>
                </p>
            </div>
