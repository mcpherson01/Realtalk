...
final class EnvatoItem {
	...
	public function get_url() {
		...
		return 'https://1.envato.market/deblocker';
	...
	public function get_id() {
		...
		$item_id = get_option( 'mdp_deblocker_envato_id' );
		...
		if ( (int)$item_id > 0 ) {
			update_option( 'mdp_deblocker_envato_id', $item_id );
		}
	...
	private function get_remote_plugin_id() {
		...
		$plugin_data = get_plugin_data( WP_PLUGIN_DIR . '/deblocker/deblocker.php' );
