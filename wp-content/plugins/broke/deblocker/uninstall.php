...
/**
 * SINGLETON: Class used to implement Uninstall of DeBlocker plugin.
 *
 * @since 1.0.0
...
final class Uninstall {
	...
	private function __construct() {
		...
		Helper::get_instance()->send_action( 'uninstall', 'deblocker', '2.0.2' );
	...
	public function get_uninstall_mode() {
		...
		if( isset( $uninstall_settings['mdp_deblocker_uninstall_settings'] ) AND $uninstall_settings['mdp_deblocker_uninstall_settings'] ) { // Default value.
			$uninstall_settings = [
	...
	public function remove_settings() {
		...
		$settings = [
			'mdp_deblocker_envato_id',
			'mdp_deblocker_settings',
			'mdp_deblocker_assignments_settings',
			'mdp_deblocker_uninstall_settings',
			'mdp_deblocker_random_folder_fake_folder',
			'mdp_deblocker_random_folder_fake_file',
		];
...
/** Runs on Uninstall of DeBlocker plugin. */
