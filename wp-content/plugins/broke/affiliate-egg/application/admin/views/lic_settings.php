<div class="wrap">
    ...
    <?php if (Keywordrush\AffiliateEgg\AffiliateEgg::isActivated()): ?>
        <br>
        <?php _e('Plugin is activated', 'affegg'); ?>
    <?php endif; ?>    
    ...
    <?php if (Keywordrush\AffiliateEgg\AffiliateEgg::isEnvato() && Keywordrush\AffiliateEgg\AffiliateEgg::isActivated()): ?>
        <h2><?php _e('Deactivate license', 'affegg'); ?></h2>
        <?php _e('You can transfer your license to another domain.', 'affegg'); ?>
        <?php _e('After deactivating license, you must deactivate and delete Affiliate Egg from current domain to use plugin on another domain.', 'affegg'); ?>
        <br>
        <br>
