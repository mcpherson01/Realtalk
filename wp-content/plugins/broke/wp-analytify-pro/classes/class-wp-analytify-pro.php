...
if ( ! class_exists( 'WP_Analytify_Pro' ) ) {
	...
	class WP_Analytify_Pro extends WP_Analytify_Pro_Base {
		...
		private function hooks() {
			...
			add_action( 'wp_analytify_view_ajax_error', array( $this, 'include_ajax_error'), 10, 3 );
			add_action( 'wp_analytify_view_404_error', array( $this, 'include_404_error'), 10, 3 );
			add_action( 'wp_analytify_view_javascript_error', array( $this, 'include_javascript_error'), 10, 3 );
		...
		function include_compare_stats( $start_date, $end_date, $compare_start_date, $compare_end_date ) {
			...
			if ( isset( $_POST['view_data'] )  ) { // Custom Date Range.
				...
				$this_month_start_date         = date( 'Y-m-d', strtotime( '-31 day' ) );
				$this_month_end_date           = date( 'Y-m-d', strtotime( 'now' ) );

				$previous_month_start_date     = date( 'Y-m-d', strtotime( '-62 day' ) );
				$previous_month_end_date       = $this_month_start_date;

				$this_year_start_date          = date( 'Y-m-d', strtotime( '-1 year' ) );
				$this_year_end_data            = $this_month_end_date;

				$previous_year_start_date     = date( 'Y-m-d', strtotime( '-2 year' ) );
				$previous_year_end_date       = $this_year_start_date;

			}

			// Delete compare stats transient.
			if ( 'on' === $wp_analytify->settings->get_option( 'delete_dashboard_cache','wp-analytify-dashboard' ) || WPANALYTIFY_Utils::force_clear_cache() ) {
				delete_transient( md5( 'show-this-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
				delete_transient( md5( 'show-previous-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
				delete_transient( md5( 'show-this-year-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
				delete_transient( md5( 'show-previous-year-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
			}

			$this_month_stats = get_transient( md5( 'show-this-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
			if ( $this_month_stats === false ) {
				$this_month_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:users,ga:pageviews', $this_month_start_date, $this_month_end_date, 'ga:date', false, false, 1000 );
				set_transient( md5( 'show-this-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) , $this_month_stats, 60 * 60 * 20  );
			}

			$previous_month_stats = get_transient( md5( 'show-previous-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
			if ( $previous_month_stats === false ) {
				$previous_month_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:users,ga:pageviews', $previous_month_start_date, $previous_month_end_date, 'ga:date', false, false, 1000 );
				set_transient( md5( 'show-previous-month-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) , $previous_month_stats, 60 * 60 * 20  );
			}

			$this_year_stats = 	 get_transient( md5( 'show-this-year-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
			if ( $this_year_stats === false ) {
				$this_year_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:users,ga:pageviews', $this_year_start_date, $this_year_end_data, $year_dimensions, false, false, 10000 );
				set_transient( md5( 'show-this-year-stats' . $dashboard_profile_ID  ) , $this_year_stats, 60 * 60 * 20  );
			}

			$previous_year_stats = get_transient( md5( 'show-previous-year-stats' . $dashboard_profile_ID . $this_month_start_date . $this_month_end_date . $this_year_start_date . $this_year_end_data  ) );
			if ( $previous_year_stats === false  ) {
				$previous_year_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:users,ga:pageviews', $previous_year_start_date, $previous_year_end_date, $year_dimensions, false, false, 10000 );
				set_transient( md5( 'show-previous-year-stats' . $dashboard_profile_ID  ) , $previous_year_stats, 60 * 60 * 20  );
			}
		...
		function include_ajax_error( $start_date, $end_date, $dashboard_profile_ID ) {
				...
				<div class="analytify_general_status analytify_status_box_wraper">
					<div class="analytify_status_header">
						<h3><?php esc_html_e( 'Top Ajax Errors', 'wp-analytify-pro' ); ?></h3>
					...
					<div class="analytify_status_body stats_loading">
						...
						<div class="analytify_status_footer">
							<span class="analytify_info_stats"><?php esc_html_e( 'List of the ajax errors.', 'wp-analytify-pro' ); ?></span>
						</div>
		...
		public function include_404_error( $start_date, $end_date, $dashboard_profile_ID ) {
			if( 'on' === $this->settings->get_option( '404_page_track', 'wp-analytify-advanced' ) ):
			?>

			<div class="analytify_general_status analytify_status_box_wraper">
				<div class="analytify_status_header">
					<h3><?php esc_html_e( 'Top 404 Pages Errors', 'wp-analytify-pro' ); ?></h3>
					<span class="analytify_top_page_detials analytify_tp_btn">
				...
				<div class="analytify_status_body stats_loading">
					...
					<div class="analytify_status_footer">
						<span class="analytify_info_stats"><?php esc_html_e( 'List of the 404 errors.', 'wp-analytify-pro' ); ?></span>
					</div>
			</div>
		...
		public function include_javascript_error( $start_date, $end_date, $dashboard_profile_ID ) {
			...
			if ( 'on' == $this->settings->get_option( 'javascript_error_track', 'wp-analytify-advanced' )  ) :
				...
				<div class="analytify_general_status analytify_status_box_wraper">
					<div class="analytify_status_header">
						<h3><?php esc_html_e( 'Top Javascript Errors', 'wp-analytify-pro' ); ?></h3>
						<span class="analytify_top_page_detials analytify_tp_btn">
					...
					<div class="analytify_status_body stats_loading">
						...
						<div class="analytify_status_footer">
							<span class="analytify_info_stats"><?php esc_html_e( 'List of the Javascript errors.', 'wp-analytify-pro' ); ?></span>
						</div>
					</div>
				<?php
			endif;
		...
		function license_tab_content() {
			...
			<div class="wrap">
				<form method="post" action="">
					...
					<p class="inside" for="analytify_license_key"><?php esc_html_e( 'Enter your license key(s). It is important to have a valide license for automatic plugin updates and support. After adding license key, press Activate license button.', 'wp-analytify-pro' ); ?></p>
						...
						if ( $permission_view == '' || in_array( $current_role, $role_to_show ) ) {
							...
							for ( $i = 0; $i < count( $all_metrics ); $i++ ) {
								...
								if ( ! is_numeric( $stats->totalsForAllResults[ $all_metrics[ $i ] ] ) ) {
									...
									$return       .= $GLOBALS['WP_ANALYTIFY']->wpa_number_format( $stats->totalsForAllResults[ $all_metrics[ $i ] ] ) ;
								}
								...
								foreach ( $stats['rows'] as $b_stat ) {
									...
									for ( $i = 0; $i < count( $b_stat ); $i++ ) {
										...
										if ( ! is_numeric( $b_stat[ $i ] ) ) {
											...
											$return .= '<td>' . $GLOBALS['WP_ANALYTIFY']->wpa_number_format( $b_stat[ $i ] ) . '</td>'; }
									}
									$return .= '</tr>';
								}
							}
		...
		*/
				...
				if ( in_array( 'show-geographic-dashboard', $show_settings ) ) {
					...
					<div class="analytify_general_status analytify_status_box_wraper">
						...
						<div class="analytify_status_body">
							...
							$country_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date , 'ga:country' , '-ga:sessions' , 'ga:country!=(not set);'.$filter , false );
							$cities_stats 		= $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date , 'ga:city,ga:country' , '-ga:sessions' , 'ga:city!=(not set);ga:country!=(not set);'.$filter , 5 );
				...
				if ( in_array( 'show-system-stats', $show_settings ) ) { ?>
					<div class="analytify_general_status analytify_status_box_wraper">
						...
						<div class="">
							...
							$browser_stats 	= $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date , 'ga:browser,ga:operatingSystem' , '-ga:sessions' , 'ga:browser!=(not set);ga:operatingSystem!=(not set);'.$filter, 5 );

							$os_stats 			= $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date , 'ga:operatingSystem,ga:operatingSystemVersion' , '-ga:sessions' , 'ga:operatingSystemVersion!=(not set);'.$filter, 5 );


							$mobile_stats 	= $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date , 'ga:mobileDeviceBranding,ga:mobileDeviceModel' , '-ga:sessions' , 'ga:mobileDeviceModel!=(not set);ga:mobileDeviceBranding!=(not set);'.$filter, 5 );
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-keywords-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_body">
								<?php
								$keyword_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date, 'ga:keyword', '-ga:sessions', $filter, 8 );
					...
					if ( in_array( 'show-social-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_body">
								...
								$social_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date, 'ga:socialNetwork', '-ga:sessions', 'ga:socialNetwork!=(not set);'.$filter, 7 );
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-referrer-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_body">
								<?php
								$referr_stats = $wp_analytify->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date, 'ga:source,ga:medium', '-ga:sessions', $filter, 7 );
							...
							<div class="analytify_status_footer">
								<span class="analytify_info_stats"><?php analytify_e( 'who are the strong Referrers to your site ?? See above', 'wp-analytify' ); ?></span>
							</div>
						</div>
						<?php
					}
		...
		public function get_single_admin_analytics( $start_date = '', $end_date = '', $postID = 0, $ajax = 0 ) {
			...
			if ( ! empty( $show_settings ) ) {
				...
				if ( is_array( $show_settings ) ) {
					...
					if ( in_array( 'show-overall-back', $show_settings ) ) {
						...
						if ( isset( $stats->totalsForAllResults ) ) {
							...
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/single-general-stats.php';
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-country-back', $show_settings ) ) {
						$country_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:country', '-ga:sessions', $filter,5 );
						if ( isset( $country_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/country-stats.php';
							pa_include_country( $this, $country_stats );
						}
					}
				}

				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-city-back', $show_settings ) ) {
						$city_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:city', '-ga:sessions', $filter, 5 );
						if ( isset( $city_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/city-stats.php';
							pa_include_city( $this, $city_stats );
						}
					}
				}

				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-keywords-back', $show_settings ) ) {
						$keyword_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:keyword', '-ga:sessions',$filter,10 );
						if ( isset( $keyword_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/keywords-stats.php';
							pa_include_keywords( $this, $keyword_stats );
						}
					}
				}

				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-social-back', $show_settings ) ) {
						$social_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:socialNetwork', 'ga:sessions',$filter, 10 );
						if ( isset( $social_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/social-stats.php';
							pa_include_social( $this, $social_stats );
						}
					}
				}

				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-browser-back', $show_settings ) ) {
						$browser_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:browser,ga:operatingSystem', '-ga:sessions',$filter,5 );
						if ( isset( $browser_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/browser-stats.php';
							pa_include_browser( $this, $browser_stats );
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-os-back', $show_settings ) ) {
						$os_stats = $this->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date, 'ga:operatingSystem,ga:operatingSystemVersion', '-ga:sessions', $filter, 5 );
						if ( isset( $os_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/os-stats.php';
							pa_include_operating( $this, $os_stats );
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-mobile-back', $show_settings ) ) {
						$mobile_stats = $this->pa_get_analytics_dashboard( 'ga:sessions', $s_date, $e_date, 'ga:mobileDeviceInfo', '-ga:sessions', $filter, 5 );
						if ( isset( $mobile_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/mobile-stats.php';
							pa_include_mobile( $this, $mobile_stats );
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-referrer-back', $show_settings ) ) {
						$referr_stats = $this->pa_get_analytics( 'ga:sessions', $s_date, $e_date, 'ga:source,ga:medium', '-ga:sessions',$filter,10 );
						if ( isset( $referr_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/referrers-stats.php';
							pa_include_referrers( $this, $referr_stats );
						}
					}
				}

				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-pages-back', $show_settings ) ) {
						$page_stats = $this->pa_get_analytics( 'ga:entrances,ga:pageviews,ga:exits', $s_date, $e_date, 'ga:PagePath', '-ga:exits', $filter, 5 );
						if ( isset( $page_stats->totalsForAllResults ) ) {
							include_once ANALYTIFY_ROOT_PATH . '/views/admin/single-pages-stats.php';
							pa_single_pages_stats( $this, $page_stats );
						}
					}
				}
			} else {
				...
				if ( isset( $stats->totalsForAllResults ) ) {
					include_once ANALYTIFY_ROOT_PATH . '/views/admin/general-stats.php';
					wpa_include_single_general( $this, $stats );
				}
			}
		}
...
<!-- 			 <tr class="plugin-update-tr wpanalytifypro-custom">
			...
			$pro_fields = array(
				'wp-analytify-front' => array(
					array(
						...
						'desc'              => __( 'Check it, if you don\'t want to load Analytics at all. Remember, you can use Shortcodes still.', 'wp-analytify-pro' ),
						'type'              => 'checkbox',
					),
					array(
						'name'              => 'show_analytics_roles_front_end',
						'label'             => analytify__( 'Show Analytics to (roles)', 'wp-analytify' ),
						'desc'              => analytify__( 'Show Analytics to above selected user roles only.', 'wp-analytify' ),
						'type'              => 'chosen',
						'default' 			=> array(),
					...
					array(
						...
						'label'             => __( 'Analytics on Post types', 'wp-analytify-pro' ),
						'desc'              => __( 'Show Analytics under the above post types only.', 'wp-analytify-pro' ),
						'type'              => 'chosen',
						'default' 			=> array(),
					...
					array(
						...
						'desc'              => __( 'Select which Stats panels you want to display at front-end.', 'wp-analytify-pro' ),
						'type'              => 'Chosen',
						'default' 			=> array(),
						'options' => array(
					...
					array(
						...
						'desc'              => __( 'Enter ID\'s of posts or pages separated by commas on which you don\'t want to show Analytics e.g 11,45,66', 'wp-analytify-pro' ),
						'type'              => 'text',
						'default'           => '',
				...
				'wp-analytify-dashboard' => array(
					array(
						...
						'desc'              => __( 'Analytify dashboard (except Real Time Stats) is saving results for 20 hours. If you want to fetch the current stats, Enable this check and Press \'Save Changes\' below.', 'wp-analytify-pro' ),
						'type'              => 'checkbox',
					),
					array(
						'name'              => 'show_analytics_roles_dashboard',
						'label'             => analytify__( 'Show Analytics to (roles)', 'wp-analytify' ),
						'desc'              => __( 'Show Analytify Dashboard to above selected user roles only.', 'wp-analytify-pro' ),
						'type'              => 'chosen',
						'default' 			=> array(),
						'options' => WP_Analytify_Settings::get_current_roles(),
					),
					...
					array(
						...
						'desc'              => analytify__( 'Show Analytics under the above post types only.', 'wp-analytify' ),
						'type'              => 'chosen',
						'default' 			=> array(),
						'options' => array(
							...
							// 'show-browser-dashboard'    => 'Browser Stats',
							// 'show-mobile-dashboard'     => 'Mobile devices Stats',
							// 'show-os-dashboard'         => 'Operating System Stats',
							// 'show-city-dashboard'       => 'City Stats',
						),
					),
				),
		...
		*/
		function add_admin_bar_menu( $menus ) {
			...
			$menus['analytify-dashboard&show=detail-realtime'] = 'Real Time';
			$menus['analytify-dashboard&show=detail-demographic'] = 'Demographics';
			return $menus;
		}
		...
		function top_page_text() {
			...
			<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-pages">
				<span class="analytify_tooltiptext">Export Top Pages</span>
			</a>
			<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			<?php
		}
		...
		function top_keyword_text() {
			...
			<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-keywords">
				<span class="analytify_tooltiptext">Export Top Keywords</span>
			</a>
			<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			<?php
		}
		...
		function top_social_media_text() {
			...
			<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-social-media">
				<span class="analytify_tooltiptext">Export Top Social Media</span>
			</a>
			<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			<?php
		}
		...
		function top_reffers_text() {
			...
			<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-reffers">
				<span class="analytify_tooltiptext">Export Top Reffers</a>
			<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			<?php
		}
		...
		function top_page_stats_text() {
			...
			<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="what-happen">
				<span class="analytify_tooltiptext">Export Stats</a>
			<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			<?php
		}
		...
		function after_top_mobile_device_text() {
			...
			<span class="analytify_top_geographic_detials analytify_tp_btn">
				<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-mobile-device">
					<span class="analytify_tooltiptext">Export Top Mobile Device</span>
				</a>
				<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			</span>
			<?php
		...
		function after_top_operating_system_text() {
			...
			<span class="analytify_top_geographic_detials analytify_tp_btn">
				<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-operating-system">
					<span class="analytify_tooltiptext">Export Top Operating System</span>
				</a>
				<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			</span>
			<?php
		...
		function after_top_browser_text() {
			...
			<span class="analytify_top_geographic_detials analytify_tp_btn">
				<a href="#" class="analytify-export-data analytify_tooltip" data-stats-type="top-browsers">
					<span class="analytify_tooltiptext">Export Top Browsers</span>
				</a>
				<img src="<?php echo admin_url( 'images/spinner.gif' ); ?>" class='analytify-export-loader' style="display:none">
			</span>
			<?php
