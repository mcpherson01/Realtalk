...
registerBlockType( 'contentomatic-article-builder-post-generator/contentomatic-display', {
    title: 'Contentomatic Display Posts',
    icon: 'testimonial',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'contentomatic'],
    edit: (function( props ) {
