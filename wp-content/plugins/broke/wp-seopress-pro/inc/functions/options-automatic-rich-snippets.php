	...
	if(is_single() || is_singular()){
		...
		function seopress_automatic_rich_snippets_products_option($schema_datas) {
			...
			if(count(array_filter($schema_datas,'strlen')) != 0) {
				...
				if (isset($product) && $products_global_ids =='' && get_post_meta($product->get_id(), 'sp_wc_barcode_type_field', true) !='' && get_post_meta($product->get_id(), 'sp_wc_barcode_type_field', true) !='none') {
				...
				if (isset($product) && $products_global_ids_value =='' && get_post_meta($product->get_id(), 'sp_wc_barcode_field', true) !='' && get_post_meta($product->get_id(), 'sp_wc_barcode_field', true) !='none') {
		...
		/*barcode type*/
		$get_barcode_type ='';
		if (isset($product) && get_post_meta($product->get_id(),'sp_wc_barcode_type_field', true)) {
			$get_barcode_type = get_post_meta($product->get_id(),'sp_wc_barcode_type_field', true);
		}

		/*barcode*/
		$get_barcode ='';
		if (isset($product) && get_post_meta($product->get_id(),'sp_wc_barcode_field', true)) {
