...
update_option('seopress_pro_license_key', 'nulled'); 
...
function seopress_pro_activation() {
    ...
    update_option('seopress_pro_license_key', 'GPL Times'); 
    update_option('seopress_pro_license_status', 'valid');
    flush_rewrite_rules();
...
//Define
///////////////////////////////////////////////////////////////////////////////////////////////////
define( 'SEOPRESS_PRO_VERSION', '3.8' ); 
...
function seopress_google_news_rewrite() {
    //Google News
    if (seopress_xml_sitemap_news_enable_option() =='1' && seopress_get_toggle_option('news') =='1') {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
//Robots Enable
function seopress_pro_robots() {
    if (seopress_get_toggle_option('robots') =='1' || (!is_network_admin() && is_multisite())) {
        if (is_multisite()) {
...
add_action('plugins_loaded', 'seopress_pro_robots');
