	...
	class Schema_WP_Event {
		...
		*/
		public function schema_output( $post_id = null ) {
			...
			// Performer name
			$performer_name = get_post_meta( $post->ID , 'schema_properties_Event_performer_name', true);
			...
			// Dates and Times
			$schema['startDate']	= get_post_meta( $post->ID , 'schema_properties_Event_startDate', true);
			$schema['endDate']		= get_post_meta( $post->ID , 'schema_properties_Event_endDate', true);
		
			// Offer Price
			$offer_price			= get_post_meta( $post->ID , 'schema_properties_Event_offer_price', true);
			$offer_priceCurrency	= get_post_meta( $post->ID , 'schema_properties_Event_offer_priceCurrency', true);
			$offer_availability 	= get_post_meta( $post->ID , 'schema_properties_Event_offer_availability', true);
			$offer_validFrom 		= get_post_meta( $post->ID , 'schema_properties_Event_offer_validFrom', true);
			$offer_url		 		= get_post_meta( $post->ID , 'schema_properties_Event_offer_url', true);
			...
			// Address
			$venue_name			= get_post_meta( $post->ID , 'schema_properties_Event_venue_name', true);
			$streetAddress		= get_post_meta( $post->ID , 'schema_properties_Event_streetAddress', true);
			$streetAddress_2 	= get_post_meta( $post->ID , 'schema_properties_Event_streetAddress_2', true);
			$streetAddress_3 	= get_post_meta( $post->ID , 'schema_properties_Event_streetAddress_3', true);
			$addressLocality	= get_post_meta( $post->ID , 'schema_properties_Event_addressLocality', true);
			$addressRegion 		= get_post_meta( $post->ID , 'schema_properties_Event_addressRegion', true);
			$postalCode 		= get_post_meta( $post->ID , 'schema_properties_Event_postalCode', true);
			$addressCountry 	= get_post_meta( $post->ID , 'schema_properties_Event_addressCountry', true);
			
			// Geo Location
			$latitude 	= get_post_meta( $post->ID , 'schema_properties_Event_geo_latitude', true);
			$longitude 	= get_post_meta( $post->ID , 'schema_properties_Event_geo_longitude', true);
