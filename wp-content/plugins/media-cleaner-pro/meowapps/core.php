...
class MeowAppsPro_WPMC_Core {
	...
	"wp-security-audit-log", "maxmegamenu", "woocommerce_uploads", "wc-logs", "bb-plugin" );
	...
	function check_file( $result, $path ) {
		...
		$path = $this->core->clean_uploaded_filename( $path );
		if ( $this->core->reference_exists( $path, null ) )
			return true;
