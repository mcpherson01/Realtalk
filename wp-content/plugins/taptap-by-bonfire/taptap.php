...
*/
	...
	function taptap_theme_customizer( $wp_customize ) {
        ...
        $wp_customize->add_control('taptap_secondary_menu_button_label',array('type' => 'text','label' => 'Secondary label','description' => 'Secondary label is displayed when menu is opened.','section' => 'taptap_menu_button_section',));
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'taptap_secondary_logo_image',
            array(
                'label' => 'Upload secondary logo image',
                'description' => 'This image will replace the original logo image when the menu is opened. Useful if you would like to switch to a logo with a different color scheme when the menu is open.',
        ...
        $wp_customize->add_control('taptap_header_bg_pattern',array('type' => 'checkbox','label' => 'Show background image as pattern','section' => 'taptap_header_section',));
        ...
        $wp_customize->add_control('taptap_header_bg_image_opacity',array('type' => 'text','label' => 'Header background image opacity','description' => 'From 0-1 (example: 0.75) If empty, defaults to 1','section' => 'taptap_header_section',));
        ...
        $wp_customize->add_control('taptap_menu_appearance_scaling_background',array('type' => 'checkbox','label' => 'Extend scaling to background', 'description' => 'If unchecked, scaling is applied to menu contents only','section' => 'taptap_container_section',));
        ...
        $wp_customize->add_control('taptap_background_image_width',array('type' => 'text','label' => 'Background image width','description' => 'Can be entered in pixels or percentages (example: 200px or 50%). Height displayed proportionally. If empty, defaults to full screen.','section' => 'taptap_container_section',));
        ...
        $wp_customize->add_control('taptap_background_horizontal_alignment_num',array('type' => 'text','label' => 'Background image horizontal alignment','description' => 'Can be entered in pixels or percentage (example: 200px or 25%). Overrides the option above.','section' => 'taptap_container_section',));
        ...
        $wp_customize->add_control('taptap_background_vertical_alignment_num',array('type' => 'text','label' => 'Background image vertical alignment','description' => 'Can be entered in pixels or percentage (example: 200px or 25%). Overrides the option above.','section' => 'taptap_container_section',));
        ...
        $wp_customize->add_control('taptap_menu_item_animation',array('type' => 'checkbox','label' => 'Menu item appearance animation','description' => 'When selected, menu items will animate individually upon menu activation (additional settings found below).','section' => 'taptap_menu_submenu_section',));
        ...
        $wp_customize->add_control('taptap_menu_item_animation_origin',array('type' => 'text','label' => 'Menu item appearance origin (in pixels)','description' => 'Distance from which the menu item appearance animation originates (negative values accepted). If empty, defaults to 50','section' => 'taptap_menu_submenu_section',));
        ...
        $wp_customize->add_control('taptap_menu_description_above',array('type' => 'checkbox','label' => 'Display menu item descriptions above menu items','description' => 'If unchecked, descriptions will be displayed below menu items','section' => 'taptap_menu_description_section',));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'taptap_widget_link_hover_color',array(
            'label' => 'Widget link (hover)', 'settings' => 'taptap_widget_link_hover_color', 'section' => 'taptap_menu_widget_section' )
        ));
        ...
        //
        // ADD "Image-based Menu" SECTION TO "TapTap Plugin" PANEL
        //
        $wp_customize->add_section('taptap_image_menu_section',array('title' => __( 'Image-based Menu', 'taptap' ),'panel' => 'taptap_panel','priority' => 9));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_first_menu_item_color',array(
            'label' => 'First menu item','settings' => 'taptap_image_menu_first_menu_item_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_submenu_item_color',array(
            'label' => 'Sub-menu items','settings' => 'taptap_image_menu_submenu_item_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_submenu_item_hover_color',array(
            'label' => 'Sub-menu items (hover)','settings' => 'taptap_image_menu_submenu_item_hover_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_dropdown_color',array(
            'label' => 'Dropdown indicator','settings' => 'taptap_image_menu_dropdown_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_dropdown_bg_color',array(
            'label' => 'Dropdown indicator background','settings' => 'taptap_image_menu_dropdown_bg_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_submenu_dropdown_color',array(
            'label' => 'Submenu dropdown indicator','settings' => 'taptap_image_submenu_dropdown_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_submenu_dropdown_bg_color',array(
            'label' => 'Submenu dropdown indicator background','settings' => 'taptap_image_submenu_dropdown_bg_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_bg_color',array(
            'label' => 'Background','settings' => 'taptap_image_menu_bg_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'taptap_image_menu_scrollbar_color',array(
            'label' => 'Scrollbar','settings' => 'taptap_image_menu_scrollbar_color','section' => 'taptap_image_menu_section' )
        ));
        ...
        $wp_customize->add_control('taptap_image_menu_animation_origin',array('type' => 'text','label' => 'Appearance animation origin (in pixels)','description' => 'Negative values accepted. If empty, defaults to 125','section' => 'taptap_image_menu_section',));
        ...
        $wp_customize->add_control('taptap_image_menu_animation_opacity',array('type' => 'text','label' => 'Appearance animation opacity','description' => 'From 0-1. To disable fade-in of menu items, enter value as 1','section' => 'taptap_image_menu_section',));
        ...
        $wp_customize->add_control('taptap_image_menu_corner_roundness',array('type' => 'text','label' => 'Corner roundness (in pixels)','description' => 'If empty, defaults to 7','section' => 'taptap_image_menu_section',));
        ...
        $wp_customize->add_control('taptap_image_menu_item_gap',array('type' => 'text','label' => 'Gap between top-level menu items (in pixels)','description' => 'If empty, defaults to 20','section' => 'taptap_image_menu_section',));
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'taptap_image_menu_image_one',
            array(
                'label' => '1st menu item image',
                'settings' => 'taptap_image_menu_image_one',
                'section' => 'taptap_image_menu_section',
        )
        ));
        ...
        //
        $wp_customize->add_section('taptap_alt_close_section',array('title' => __( 'Alternate Close Button', 'taptap' ),'panel'  => 'taptap_panel','priority' => 9));
        ...
        $wp_customize->add_control('taptap_show_alt_close',array('type' => 'checkbox','label' => 'Show alternate close button','description' => 'Useful for cases where the default menu button (which transforms and also behaves as the close button) is hidden and a custom element is used to activate the menu.', 'section' => 'taptap_alt_close_section',));
        ...
        $wp_customize->add_control('taptap_alt_close_absolute_position',array('type' => 'checkbox','label' => 'Absolute position','description' => 'If unchecked, the close button will stick to the top when the menu is scrolled.', 'section' => 'taptap_alt_close_section',));
        ...
        $wp_customize->add_control('taptap_alt_close_position_left',array('type' => 'checkbox','label' => 'Align left','description' => 'Position left. If unchecked, the close button will be positioned on right side of screen.', 'section' => 'taptap_alt_close_section',));
        ...
        $wp_customize->add_control('taptap_alt_close_hover_minus',array('type' => 'checkbox','label' => 'Hover animation','description' => 'When enabled, the close button will animate into a minus sign on hover.', 'section' => 'taptap_alt_close_section',));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'taptap_alt_close_color',array(
            'label' => 'Alternate close button', 'settings' => 'taptap_alt_close_color', 'section' => 'taptap_alt_close_section' )
        ));
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'taptap_alt_close_hover_color',array(
            'label' => 'Alternate close button (hover)', 'settings' => 'taptap_alt_close_hover_color', 'section' => 'taptap_alt_close_section' )
        ));
        ...
        $wp_customize->add_control('taptap_alt_close_top_distance',array(
            'type' => 'text',
            'label' => 'Top distance',
            'description' => 'Example: 45. If empty, defaults to 20.',
	...
	if (function_exists('register_nav_menus')) {
		register_nav_menus( array(
            'taptap-by-bonfire' => ( 'TapTap: Main Menu' ),
