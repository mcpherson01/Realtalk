...
$rocket_cookie_hash = '2ce714d90e0fead03b983fedc376b357';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '5e5294c3cf368341640414';
$rocket_cache_mobile = '1';
$rocket_do_caching_mobile_files = '1';
$rocket_cache_ssl = '0';
$rocket_cache_reject_uri = '/wp/wordpress(/(.+/)?feed/?|/(index\.php/)?wp\-json(/.*|$))';
